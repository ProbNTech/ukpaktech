  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden pt-36 pb-20 lg:pt-44 lg:pb-28">
        ...
        <div className="absolute bottom-10 right-10 w-64 h-64 rounded-full opacity-15 blur-3xl" style={{ background: "radial-gradient(circle, #22C55E 0%, transparent 70%)" }} />
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20 text-center max-w-3xl mx-auto">
          ...
          >
            ...
            <span className="text-[12px] font-bold uppercase tracking-[0.25em] text-[#93c5fd]">
              Our Partners
            </span>
          </motion.div>
          ...
          >
            {[
              { icon: Users, label: `${featuredPartners.length} Partners`, color: "#3B82F6" },
              { icon: Sparkles, label: `${partnerCategories.length - 1} Sectors`, color: "#22C55E" },
      ...
      <GlobalCTA
        ...
        title="Want to feature your business on UPTECH?"
