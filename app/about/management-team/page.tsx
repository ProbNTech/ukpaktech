  ...
  return (
    <div>
      ...
      <Section variant="light">
        <AnimatedSection>
          <SectionHeader label="Our Framework" title="Organisational Structure" subtitle="UPTECH operates through a clearly defined hierarchy with defined roles, responsibilities, and reporting lines." color="blue" />
      ...
      <GovernanceSection
        ...
        desc="Day-to-day operations and strategic execution of UPTECH's programmes, initiatives, and member services."
