...
const exploreItems = [
  ...
  { icon: Award, title: "Leadership", desc: "Meet our President Khalil Choudhary and Chairman Hussnain Kazmi — the leaders of UPTECH.", href: "/about/founder", color: "#C41E3A" },
