...
export default function EventsPage() {
  ...
  return (
    <div className="bg-[#0a0e1e]">
      ...
      {/* ============================================================ */}
      {/*  EVENTS GRID WITH FUTURISTIC FILTERS                          */}
      {/* ============================================================ */}
      <section
        className="relative"
        style={{
          background:
            "linear-gradient(180deg, #0a0e1e 0%, #111528 40%, #0f1220 100%)",
        }}
      >
        {/* Subtle grid pattern */}
        <div
        ...
        <div className="relative z-10 px-8 sm:px-12 lg:px-16 xl:px-20 py-16 lg:py-20">
          <AnimatedSection>
            ...
            <div className="mb-12">
              ...
              <h2
                className="font-heading font-extrabold text-3xl sm:text-4xl lg:text-[2.75rem] leading-tight mb-3"
                style={{
                  background:
            ...
            {/* Filter tabs — futuristic dark glass */}
                ...
                return (
                  <motion.button
                    ...
                    style={{
                      ...
                      boxShadow: isActive
                        ? `0 0 20px ${color}18, inset 0 1px 0 ${color}15`
                        : "none",
