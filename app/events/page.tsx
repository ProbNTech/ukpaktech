...
/*  Filter / sort types                                                 */
/* ------------------------------------------------------------------ */
type CategoryFilter = "All" | "London" | "Europe" | "Pakistan" | "UPTECH";
...
const CATEGORY_TABS: { label: string; value: CategoryFilter; color: string }[] = [
  ...
  { label: "London", value: "London", color: "#2563EB" },
  { label: "Europe", value: "Europe", color: "#7C3AED" },
  { label: "Pakistan", value: "Pakistan", color: "#22C55E" },
  { label: "UPTECH", value: "UPTECH", color: "#C41E3A" },
];
...
export default function EventsPage() {
  ...
  const stats = [
    ...
    { label: "Upcoming", value: upcomingEvents.length, color: "#22C55E" },
    { label: "Past", value: pastEvents.length, color: "#C41E3A" },
    { label: "London", value: events.filter((e) => e.category === "London").length, color: "#2563EB" },
    { label: "Europe", value: events.filter((e) => e.category === "Europe").length, color: "#7C3AED" },
    { label: "Pakistan", value: events.filter((e) => e.category === "Pakistan").length, color: "#22C55E" },
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <PageHero
        ...
        heroVideo="/image/banners/events-video.mp4"
        heroVideoSpeed={2}
      />
