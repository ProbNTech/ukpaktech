  ...
  return (
    <div className="bg-[#0B0F1A]">
      ...
      <section className="relative bg-[#0B0F1A] overflow-hidden">
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20 py-20 lg:py-28">
          <AnimatedSection>
            ...
            {/* VIP Features */}
            <div className="backdrop-blur-md bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 relative overflow-hidden">
      ...
      <section className="relative bg-[#131942] overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full bg-[#8b5cf6]/5 blur-[200px] pointer-events-none" />
        <div
          className="absolute inset-0 opacity-[0.015]"
          style={{
            backgroundImage: `radial-gradient(circle at 1px 1px, rgba(255,255,255,0.3) 1px, transparent 0)`,
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-2">
                <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-sm p-8 sticky top-8 overflow-hidden relative">
                  ...
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-24 bg-gradient-to-b from-[#2563EB]/10 to-transparent blur-xl pointer-events-none" />
