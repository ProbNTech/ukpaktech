  ...
  return (
    <main>
            ...
            <AnimatedSection>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-[#22C55E] uppercase tracking-wider mb-1">
                      Next
                    </p>
      ...
      <GlobalCTA
        ...
        subtitle="UPTECH provides the connections, intelligence, and support your company needs to succeed in Europe."
