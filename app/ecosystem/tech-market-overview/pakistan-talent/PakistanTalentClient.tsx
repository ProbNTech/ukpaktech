...
function AnimatedStatCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-3xl sm:text-4xl font-extrabold text-[#1a2b5e] mb-1">
        {prefix}
        {isInView ? (
          <CountUp
            end={end}
      ...
      <p className="font-semibold text-[#1a2b5e] mb-1">{label}</p>
  ...
  return (
    <main>
        ...
        <div className="px-8 sm:px-12 lg:px-16 xl:px-20 py-14 lg:py-20">
          ...
          <AnimatedSection>
            <div className="bg-white rounded-xl border border-[#e2e0dc] p-6 h-full">
              <GraduationCap className="w-7 h-7 text-[#2563EB] mb-3" />
              <h3 className="font-heading font-bold text-lg text-[#1a2b5e] mb-3">
                {education.title}
              </h3>
          ...
          <AnimatedSection delay={0.1}>
            <div className="bg-white rounded-xl border border-[#e2e0dc] p-6 h-full">
              <Globe2 className="w-7 h-7 text-[#22C55E] mb-3" />
              <h3 className="font-heading font-bold text-lg text-[#1a2b5e] mb-3">
                {freelancing.title}
              </h3>
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-white rounded-xl border border-[#e2e0dc] p-6 h-full">
              <Building2 className="w-7 h-7 text-[#C41E3A] mb-3" />
              <h3 className="font-heading font-bold text-lg text-[#1a2b5e] mb-3">
                {ecosystem.title}
              </h3>
              <ul className="space-y-2 mb-3">
            ...
            {exports.stats.map((stat, i) => (
              <AnimatedSection key={i} delay={i * 0.08}>
                <div className="bg-white rounded-xl border border-[#e2e0dc] p-5 text-center">
                  <DollarSign className="w-6 h-6 text-[#22C55E] mx-auto mb-2" />
                  <p className="font-semibold text-[#1a2b5e] text-sm">
                    {stat}
                  </p>
                </div>
              </AnimatedSection>
            ...
            {governmentSupport.map((org, i) => (
              <AnimatedSection key={org.name} delay={i * 0.08}>
                <div className="flex gap-4 bg-white rounded-xl border border-[#e2e0dc] p-5">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1a2b5e] mb-1">
                      {org.name}
                    </h3>
        ...
        <div className="px-8 sm:px-12 lg:px-16 xl:px-20 py-14 lg:py-20">
            <AnimatedSection>
              <Link
                ...
                className="group block bg-gradient-to-r from-[#2563EB]/10 to-[#22C55E]/10 rounded-2xl border border-[#2563EB]/20 p-8 hover:shadow-lg transition-all"
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="font-heading font-bold text-xl text-[#1a2b5e] mb-2">
      ...
      <GlobalCTA
        ...
        subtitle="UPTECH connects UK and European businesses with Pakistan's growing technology ecosystem."
