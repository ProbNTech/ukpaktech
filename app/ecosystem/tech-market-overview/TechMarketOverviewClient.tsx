...
function StatsStrip() {
  ...
  return (
    <div ref={ref} className="bg-[#1a2b5e] rounded-2xl p-6 sm:p-8 lg:p-10">
...
export default function TechMarketOverviewClient() {
  return (
    <main>
      <PageHero
        label="UPTECH Market Intelligence"
        title={
          <>
            UK/Europe Tech
            <br />
              ...
              return (
                <AnimatedSection key={pillar.title} delay={i * 0.08}>
                  <div className="bg-white rounded-xl border border-[#e2e0dc] p-5 text-center h-full hover:shadow-md transition-shadow">
                    ...
                    <h3 className="font-semibold text-[#1a2b5e] mb-1 text-sm">
                      {pillar.title}
                    </h3>
          ...
          <AnimatedSection delay={0.15}>
            ...
            <div className="md:hidden space-y-3">
              {countrySummary.map((row) => (
                ...
                >
                  <h4 className="font-semibold text-[#2563EB] mb-2">{row.country}</h4>
        ...
        <div className="px-8 sm:px-12 lg:px-16 xl:px-20 py-14 lg:py-20">
          ...
          <AnimatedSection delay={0.15}>
            <NextLink
              ...
              className="group block bg-gradient-to-r from-[#22C55E]/10 to-[#2563EB]/10 rounded-2xl border border-[#22C55E]/20 p-8 hover:shadow-lg transition-all"
            >
      ...
      <GlobalCTA
        ...
        subtitle="Let UPTECH connect your company with the right partners, markets, and opportunities across the UK and Europe."
