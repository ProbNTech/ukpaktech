...
const termsSections = [
  ...
  },
  {
    ...
    content: [
      "4.1 You may obtain direct access via the Website to certain confidential information of UK-PAKISTAN TECH FORUM LTD (UPTECH) and its suppliers, including without limitation technical, contractual, product, program, pricing, marketing and other valuable information that should reasonably be understood as confidential (\u201CConfidential Information\u201D). You must hold Confidential Information in strict confidence. Title to Confidential Information remains with UK-PAKISTAN TECH FORUM LTD (UPTECH) and its suppliers.",
