              ...
              >
                <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                  ...
                  <p className="text-base text-[#5A5F72] leading-relaxed mb-5">
                    The UK-PAKISTAN TECH FORUM LTD (UPTECH) is the UK&apos;s leading organisation for promoting opportunities and increasing bi-later trade and investment in between UK and Pakistan. We are committed to protecting the privacy of your Personal Information. This policy sets out how we collect, use and transfer your Personal Information, the security measures we employ to protect such data and your rights and choices with regards to access or use of such data.
                  </p>
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20">
          <AnimatedSection>
            ...
            >
              ...
              <p className="text-base text-[#5A5F72] leading-relaxed">
                Your name and contact details (including postal address, email address and telephone number). The name of the organisation you work for and the events you attend. We do not collect sensitive data about you, other than dietary / any special access requirements for the purposes of event planning.
              </p>
            </motion.div>
          </AnimatedSection>
        </div>
          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 gap-5 max-w-5xl">
              {[
                ...
                { icon: AlertTriangle, title: "Right of Erasure", color: "#2563EB", desc: "You may ask us to delete some or all your personal information and in certain cases, and subject to certain exceptions; we will do so as far as we are required to. In many cases, we will anonymise that information, rather than delete it." },
          ...
          <AnimatedSection>
            ...
            <div className="grid lg:grid-cols-2 gap-6 max-w-5xl">
              <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5 }} className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <div className="h-px bg-[#D8D5CF] mb-5" />
                <p className="text-base text-[#7A7E8F] leading-relaxed mb-4">When you give us personal information, we take steps to ensure that appropriate technical and organisational controls are in place to protect it.</p>
