...
export default function SkillDevelopmentCenterPage() {
  ...
  return (
    <div className="bg-[#0B0F1A]">
      ...
      {/* ── Trust Strip ── */}
      <section className="relative bg-[#0E1221] border-b border-white/[0.06]">
      ...
      {/* ── Programs Grid ── */}
      <section className="relative bg-[#0E1221]" id="programs">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <AnimatedSection>
            <div className="mb-14">
              ...
              {programs.map((program, i) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col h-full">
                    <h3 className="font-heading font-bold text-white text-base mb-1 group-hover:text-[#22C55E] transition-colors duration-200">
                      {program.title}
                    </h3>
                    <p className="text-white/30 text-xs mb-3">{program.subtitle}</p>
      ...
      {/* ── Learning Pathway ── */}
      <section className="relative bg-[#131942]" id="pathway">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <AnimatedSection>
            <div className="mb-14">
      ...
      {/* ── Flagship Tracks ── */}
      <section className="relative bg-[#0B0F1A]" id="tracks">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <AnimatedSection>
            <div className="mb-14">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {tracks.map((track, i) => (
                ...
                >
                  ...
                  />
                  <div className="p-6 flex flex-col h-full">
                    <h3 className="font-heading font-bold text-white text-lg mb-4 group-hover:text-[#2563EB] transition-colors duration-200">
                      {track.title}
                    </h3>
                    <div className="space-y-2 mb-5">
                      <div className="flex justify-between text-sm border-b border-white/[0.08] pb-2">
                        <span className="text-white/40">Duration</span>
                        <span className="text-white/80 font-medium">{track.duration}</span>
                      </div>
                      <div className="flex justify-between text-sm border-b border-white/[0.08] pb-2">
                        <span className="text-white/40">Level</span>
                        <span className="text-white/80 font-medium">{track.level}</span>
                      </div>
                      <div className="flex justify-between text-sm border-b border-white/[0.08] pb-2">
                        <span className="text-white/40">Commitment</span>
                        <span className="text-white/80 font-medium">{track.commitment}</span>
                      </div>
                    </div>
                    <div className="flex-1">
                      <p className="text-xs font-bold text-white/30 uppercase tracking-wider mb-1">What you build</p>
                      <p className="text-white/60 text-sm leading-relaxed">{track.build}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
      ...
      {/* ── FAQ ── */}
      <section className="relative bg-[#131942]" id="faq">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <AnimatedSection>
            <div className="mb-14">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#8b5cf6] mb-4">
