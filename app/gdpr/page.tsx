...
const yourRights = [
  ...
  { icon: Lock, title: "Right to Restrict Use", color: "#f59e0b", desc: "You have a right to ask us to restrict the processing of some or all your personal information if there is a disagreement about its accuracy or we\u2019re not lawfully allowed to use it." },
  { icon: Ban, title: "Right of Erasure", color: "#C41E3A", desc: "You may ask us to delete some or all your personal information and in certain cases, and subject to certain exceptions; we will do so as far as we are required to. In many cases, we will anonymize that information, rather than delete it." },
  { icon: ArrowRightLeft, title: "Right to Portability", color: "#8b5cf6", desc: "If we are processing your personal information (1) based on your consent, or in order to enter into or carry out a contract with you, and (2) the processing is being done by automated means, you may ask us to provide it to you or another service provider in a machine-readable format." },
...
const lawfulBases = [
  ...
  { icon: CheckCircle2, title: "Legitimate Interests", color: "#f59e0b", desc: "Where it is reasonably necessary to achieve our legitimate interests, i.e. those required for running UPTIB as a B2B strategic networking organization in pursuit of our shared aims and ideals." },
  { icon: Mail, title: "Specific Consent", color: "#8b5cf6", desc: "Where you have provided specific consent to us using your personal information in a certain way, such as to send you email, text and/or contact via telephone." },
];
