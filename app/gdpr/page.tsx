...
const yourRights = [
  ...
  { icon: Ban, title: "Right of Erasure", color: "#2563EB", desc: "You may ask us to delete some or all your personal information and in certain cases, and subject to certain exceptions; we will do so as far as we are required to. In many cases, we will anonymise that information, rather than delete it." },
...
const lawfulBases = [
  ...
  { icon: CheckCircle2, title: "Legitimate Interests", color: "#C41E3A", desc: "Where it is reasonably necessary to achieve our legitimate interests, i.e. those required for running UPTECH as a B2B strategic networking organisation in pursuit of our shared aims and ideals." },
          ...
          <AnimatedSection>
            ...
            <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-30px" }} transition={{ duration: 0.4, delay: 0.3 }} className="mt-8 relative bg-gradient-to-br from-[#22C55E]/10 to-[#2563EB]/10 border border-[#22C55E]/20 rounded-xl p-6 overflow-hidden">
              <div className="relative">
                ...
                <p className="text-[#5A5F72] text-base leading-relaxed">If you want to exercise any of the above rights, please email us at{" "}<a href="mailto:info@ukpaktech.org.uk" className="text-[#22C55E] hover:text-[#4ade80] transition-colors">info@ukpaktech.org.uk</a>{" "}and clearly state in the email subject line: RIGHTS REQUEST. We may be required to ask for further information and/or evidence of identity. We will endeavor to respond fully to all requests within 10 working days of your request, however if we are unable to do so we will contact you with reasons for the delay.</p>
