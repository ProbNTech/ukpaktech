...
const processSteps = [
  {
    ...
    icon: ClipboardList,
    description: "A party may submit a formal dispute request to UPTECH including a description of the dispute, relevant agreements or documentation, and desired outcome or resolution.",
  ...
  },
  {
    ...
    icon: MessageCircle,
    description: "UPTECH will attempt to resolve the dispute through amicable mediation between the parties. The mediation process aims to encourage dialogue and reach a mutually acceptable settlement.",
  ...
  },
  {
    ...
    icon: UserCheck,
    description: "If mediation fails, UPTECH may appoint an independent arbitration panel consisting of professionals with expertise in technology law, business contracts, international trade, and digital services.",
...
const benefits = [
  {
    ...
    description: "UPTECH provides a neutral and professional environment for resolving disputes without bias.",
    icon: Globe2,
    color: "#2563EB",
  },
  {
    ...
    <div className="content-body">
      ...
      <Section variant="light">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { value: "Independent", label: "Neutral Framework", color: "#2563EB" },
            { value: "4-Step", label: "Structured Process", color: "#22C55E" },
            { value: "Expert", label: "Arbitration Panel", color: "#C41E3A" },
            { value: "Cross-Border", label: "UK & Pakistan", color: "#2563EB" },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
      ...
      <Section variant="light">
        <AnimatedSection>
          <SectionHeader
            ...
            subtitle="UPTECH arbitration services may assist in resolving disputes related to the following areas."
            color="red"
          />
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3">
              ...
              <p className="text-[#3D4152] text-lg leading-relaxed mb-5">
                If mediation fails, UPTECH may appoint an independent arbitration panel consisting of professionals with deep expertise across critical areas relevant to cross-border technology disputes.
              </p>
        ...
        <AnimatedSection>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {principles.map((principle, i) => {
              ...
              const colors = ["#60a5fa", "#86efac", "#F9A8B4", "#60a5fa"];
            ...
            {[
              {
                ...
                description: "The primary governing legislation providing the legal framework for all arbitration proceedings under UPTECH.",
                color: "#2563EB",
                icon: Gavel,
              },
              {
      ...
      {/* ── Timeline, Costs & Digital Platform ───────────────────── */}
      <Section variant="light">
        <AnimatedSection>
          <SectionHeader
            label="At a Glance"
              ...
              <div className="p-7">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#2563EB10", border: "1px solid #2563EB20" }}>
                    <Timer className="w-5 h-5 text-[#2563EB]" strokeWidth={1.5} />
                  </div>
                  ...
                  {[
                    ...
                    <li key={item.step} className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <span className="w-5 h-5 rounded-full bg-[#2563EB]/10 flex items-center justify-center text-[10px] font-bold text-[#2563EB]">{i + 1}</span>
                        <span className="text-[#3D4152] text-sm">{item.step}</span>
                      </div>
                      <span className="text-xs font-semibold text-[#2563EB] bg-[#2563EB]/8 px-2 py-0.5 rounded-full whitespace-nowrap">{item.time}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="p-7">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#22C55E10", border: "1px solid #22C55E20" }}>
                    <PoundSterling className="w-5 h-5 text-[#22C55E]" strokeWidth={1.5} />
                  </div>
                  ...
                  {[
                    ...
                    <li key={item.label}>
                      <div className="flex items-center justify-between mb-0.5">
                        ...
                        <span className="text-xs font-bold text-[#22C55E]">{item.range}</span>
                      </div>
              ...
              <div className="p-7">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#C41E3A10", border: "1px solid #C41E3A20" }}>
                    <Monitor className="w-5 h-5 text-[#C41E3A]" strokeWidth={1.5} />
                  </div>
          ...
          <AnimatedSection delay={0.3}>
            <Link
              ...
              className="group mt-8 block bg-gradient-to-r from-[#2563EB]/10 to-[#22C55E]/10 rounded-2xl border border-[#2563EB]/20 p-8 hover:shadow-lg transition-all"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-[#2563EB] uppercase tracking-wider mb-1">
                    Full Policy Document
                  </p>
                  <h3 className="font-heading font-bold text-xl text-[#1C1F2E] mb-2">
                    UPTECH Arbitration Framework Policy
                  </h3>
                ...
                <ArrowRight className="w-8 h-8 text-[#2563EB] flex-shrink-0 group-hover:translate-x-2 transition-transform" />
              </div>
            </Link>
          </AnimatedSection>
        </AnimatedSection>
            ...
            >
              ...
              <div className="p-8">
                <div className="flex items-center gap-3 mb-5">
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center"
                    style={{ background: "#C41E3A10", border: "1px solid #C41E3A20" }}
                  >
      ...
      <GlobalCTA
        ...
        subtitle="Contact UPTECH to learn more about our arbitration services or to submit a formal dispute request."
