...
const legalBasis = [
  {
    ...
    description: "The primary governing legislation for all arbitration proceedings under the UPTECH Framework.",
    icon: Gavel,
    color: "#2563EB",
  },
  {
...
const appointmentTimeline = [
  ...
  { step: "UPTECH Committee appointment (if no agreement)", duration: "5 days" },
...
const platformFeatures = [
  { title: "Secure Access", description: "Two-factor authentication (2FA) with role-based access for Claimant, Respondent, Arbitrator, and Administrator.", icon: KeyRound, color: "#2563EB" },
  { title: "Case Dashboard", description: "Notifications, case summary with status and timeline, document repository, and encrypted messaging system.", icon: Monitor, color: "#22C55E" },
  { title: "Digital Filing", description: "Submit notices, claims, defences, and evidence in PDF or approved digital formats with automatic timestamping.", icon: Upload, color: "#C41E3A" },
  { title: "Virtual Hearings", description: "Integrated video conferencing for virtual and hybrid hearing sessions with secure platform-provided links.", icon: Video, color: "#2563EB" },
  { title: "Automated Reminders", description: "Real-time alerts for deadlines, hearings, new messages, and procedural updates to keep proceedings on track.", icon: Bell, color: "#22C55E" },
  { title: "Security & Compliance", description: "All communications encrypted. GDPR and UK data protection compliant. Access restricted to authorised users. Training sessions offered for first-time users.", icon: Fingerprint, color: "#C41E3A" },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Submit a Notice of Dispute via the UPTECH Digital Arbitration Platform including details of the dispute, contract references, and requested relief.",
  },
  {
  ...
  },
  {
    ...
    a: "Parties attempt to mutually agree on arbitrator(s) within 7 days. If no agreement is reached, the UPTECH Arbitration Committee appoints arbitrator(s) from the Technical Arbitration Panel. Arbitrators must have relevant technical, industry, or legal expertise.",
  },
  {
    q: "Who can I contact for support?",
    a: "24/7 technical support is available via the platform, chat, email, or phone. The UPTECH Arbitration Committee provides procedural guidance and handles all enquiries regarding arbitration proceedings.",
  },
];
