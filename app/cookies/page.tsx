...
const cookieTypes = [
  ...
  { icon: Settings, title: "Functionality", color: "#22C55E", desc: "These cookies remember your settings and preferences and the choices you make (such as language or regional preferences) in order to help us personalise your experience and offer you enhanced functionality and content." },
...
const additionalCookieDetails = [
  { title: "User Preference", desc: "User preference \u2013 we set these to customise your website preferences, for example dismissing a popup not to show again in your browser or setting your live chat preferences." },
            ...
            <div className="space-y-6">
              <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <div className="space-y-5">
                  <p className="text-base text-[#5A5F72] leading-relaxed">Our website uses cookies, which identify technologies that your computer receives when you visit certain websites. We do not match or correlate this information with any customer information that you submit to UK-PAKISTAN TECH FORUM LTD (UPTECH).</p>
                  <p className="text-base text-[#5A5F72] leading-relaxed">Some of our web pages utilise {"\u201C"}cookies{"\u201D"} and other tracking technologies. Cookies are small pieces of data, stored in text files, that are stored on your computer or other devices when websites are loaded in a browser. They are widely used to {"\u2018"}remember{"\u2019"} you and your preferences, either for a single visit (through a {"\u2018"}session cookie{"\u2019"}) or for multiple repeat visits (using a {"\u2018"}persistent cookie{"\u2019"}). They ensure consistent and efficient experience for visitors and perform essential functions such as allowing users to register and remain logged in. Cookies may be set by the site that you are visiting (known as {"\u2018"}first-party cookies{"\u2019"}), or by other websites who serve up content on that site ({"\u2018"}third party cookies{"\u2019"}).</p>
                  <p className="text-base text-[#5A5F72] leading-relaxed">Tracking technologies may record information such as Internet domain and host names; Internet protocol (IP) addresses; browser software and operating system types; clickstream patterns; and dates and times that our site is accessed. Our use of cookies and other tracking technologies allows us to improve our web site and your web experience. We may also analyse information that does not contain personal information for trends and statistics.</p>
                  <p className="text-base text-[#5A5F72] leading-relaxed">Cookies are text files placed on your computer to collect standard internet log information and visitor behaviour information. This information is used to track visitor use of the website and to compile statistical reports on website activity. For further information visit{" "}<a href="https://www.aboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#2563EB] hover:text-[#60A5FA] transition-colors">www.aboutcookies.org</a>{" "}or{" "}<a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#2563EB] hover:text-[#60A5FA] transition-colors">www.allaboutcookies.org</a>.</p>
