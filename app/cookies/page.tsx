...
export default function CookiesPage() {
  ...
  return (
    <div>
            ...
            <div className="max-w-4xl space-y-6">
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <h3 className="font-heading font-bold text-lg text-white pt-2">What Are Cookies</h3>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <p className="text-sm text-white/50 leading-relaxed">
                    ...
                    <a href="https://www.aboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#2563EB] hover:text-[#60A5FA] transition-colors">www.aboutcookies.org</a>{" "}
                    or{" "}
                    <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#2563EB] hover:text-[#60A5FA] transition-colors">www.allaboutcookies.org</a>.
                  </p>
                  <p className="text-sm text-white/50 leading-relaxed">
      ...
      {/* ── Links to Other Websites — Dark alt section ─────────────── */}
      <section className="relative py-16 overflow-hidden" style={{ backgroundColor: "#0E1221" }}>
        ...
        {/* Glow orb */}
        <div className="absolute bottom-0 left-1/3 w-96 h-96 opacity-[0.03]" style={{ background: "radial-gradient(circle, #22C55E, transparent 60%)" }} />
            ...
            <div className="max-w-4xl">
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <h3 className="font-heading font-bold text-lg text-white pt-2">Third-Party Websites</h3>
                </div>
                <div className="h-px bg-white/[0.06] mb-5" />
                <div className="space-y-5">
                  <p className="text-sm text-white/50 leading-relaxed">
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: `linear-gradient(to bottom, ${cookie.color}, ${cookie.color}40)` }}
                    />

                    <div
                      className="relative w-10 h-10 rounded-xl flex items-center justify-center mb-4"
                      style={{ backgroundColor: `${cookie.color}10`, border: `1px solid ${cookie.color}20` }}
                    >
                      <div
                    ...
                    <h3 className="font-heading font-bold text-base text-white mb-2">{cookie.title}</h3>
                    <div className="h-px bg-white/[0.06] mb-3" />
                    <p className="text-sm text-white/40 leading-relaxed">{cookie.desc}</p>
                  </motion.div>
                );
              })}
            </div>
      ...
      {/* ── Additional Cookie Details — Dark alt section ───────────── */}
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20">
          <AnimatedSection>
            ...
            <div className="grid lg:grid-cols-2 gap-5">
              {additionalCookieDetails.map((item, i) => (
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-base text-white mb-3">{item.title}</h3>
                  <div className="h-px bg-white/[0.06] mb-3" />
            ...
            <motion.div
              ...
              className="mt-8 relative bg-gradient-to-br from-[#2563EB]/10 to-[#8b5cf6]/10 border border-[#2563EB]/20 rounded-xl p-6 overflow-hidden max-w-4xl"
            >
              ...
              <div className="relative">
                <Cookie className="w-5 h-5 text-[#60A5FA] mb-3" strokeWidth={1.5} />
            ...
            <div className="max-w-4xl">
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <h3 className="font-heading font-bold text-lg text-white pt-2">Managing Your Cookies</h3>
                </div>
                <div className="h-px bg-white/[0.06] mb-5" />
                <p className="text-sm text-white/50 leading-relaxed">
                  ...
                  <a href="https://www.aboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#f59e0b] hover:text-[#fbbf24] transition-colors">www.aboutcookies.org</a>{" "}
      ...
      {/* ── Changes, Review & General — Dark alt section ───────────── */}
      <section className="relative py-16 overflow-hidden" style={{ backgroundColor: "#131942" }}>
        {/* Grid pattern */}
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='40' height='40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h40v40H0z' fill='none'/%3E%3Cpath d='M0 40V0h40' fill='none' stroke='white' stroke-width='0.5'/%3E%3C/svg%3E\")", backgroundSize: "40px 40px" }} />
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#8b5cf6]/30 to-transparent" />
        {/* Glow orbs */}
        <div className="absolute top-0 right-1/3 w-96 h-96 opacity-[0.03]" style={{ background: "radial-gradient(circle, #8b5cf6, transparent 60%)" }} />
          ...
          <AnimatedSection>
            ...
            <div className="grid lg:grid-cols-3 gap-5 max-w-5xl">
              ...
              >
                ...
                <h3 className="font-heading font-bold text-base text-white mb-3">Changes to this Policy</h3>
                <div className="h-px bg-white/[0.06] mb-3" />
              ...
              >
                ...
                <h3 className="font-heading font-bold text-base text-white mb-3">Review</h3>
                <div className="h-px bg-white/[0.06] mb-3" />
                <p className="text-sm text-white/40 leading-relaxed">
              ...
              >
                ...
                <h3 className="font-heading font-bold text-base text-white mb-3">General</h3>
                <div className="h-px bg-white/[0.06] mb-3" />
                <p className="text-sm text-white/40 leading-relaxed">
