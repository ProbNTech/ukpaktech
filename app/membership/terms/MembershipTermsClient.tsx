...
const overviewStats = [
  { value: "Open", label: "To All Eligible Applicants", color: "#2563EB" },
  { value: "Annual", label: "Membership Term", color: "#22C55E" },
  { value: "UK Law", label: "Governed by England & Wales", color: "#C41E3A" },
  { value: "GDPR", label: "Data Protection Compliant", color: "#2563EB" },
];

/* ── Core Terms (Sections 1–5 from PDF) ────────────────────────── */
const coreTerms = [
  {
    number: "01",
    title: "Membership",
    ...
    color: "#2563EB",
    items: [
      "Membership is available to individuals or entities who meet UPTECH's membership criteria",
      "UPTECH offers different membership tiers, each with associated benefits",
  ...
  },
  {
    ...
    items: [
      ...
      "Comply with UPTECH's policies, codes of conduct, and applicable UK law",
      "Use UPTECH services responsibly and not engage in conduct that harms UPTECH or other members",
...
const legalProtections = [
  ...
  },
  {
    ...
    description: "UPTECH shall not be liable for any indirect, incidental, or consequential losses arising from membership, to the maximum extent permitted by law.",
    icon: Shield,
    color: "#22C55E",
  },
  {
    title: "Intellectual Property",
    description: "All intellectual property related to the UPTECH website, branding, content, and services are owned by UPTECH or its licensors.",
    icon: Lock,
    color: "#C41E3A",
  },
  {
  ...
  },
  {
    ...
    description: "Disputes shall be resolved through the UPTECH Arbitration Framework or in the courts located within England and Wales.",
    icon: Globe2,
    color: "#22C55E",
  },
  {
...
const faqs = [
  {
    q: "Who is eligible for UPTECH membership?",
    a: "Membership is available to individuals aged 24 years or older, or entities who meet UPTECH's membership criteria. By becoming a member, you confirm that you meet the age requirement.",
  },
  {
    q: "What membership tiers are available?",
    a: "UPTECH offers different membership tiers, each with associated benefits. Details of membership tiers and their specific benefits are provided at the time of application.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. During membership and for 36 months after termination, you agree not to solicit or hire any UPTECH employees, contractors, or personnel.",
  },
  {
...
export default function MembershipTermsClient() {
  return (
    <div className="content-body">
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3">
              ...
              <p className="text-[#5A5F72] text-lg leading-relaxed">
                All members are required to give an undertaking that they would abide by the UPTECH Code of Conduct. Adherence to the Code is mandatory for all members, ensuring consistency, integrity, and professionalism in our collective endeavours.
              </p>
            </div>
      ...
      <Section variant="light">
        <AnimatedSection>
          <SectionHeader label="Code of Conduct" title="Member Code of Conduct" subtitle="All members are required to uphold these principles. The Code of Conduct is issued under the authority of the UPTECH Constitution and is binding on all members." color="blue" />
            ...
            <div className="rounded-2xl border border-[#D8D5CF] bg-white shadow-sm p-7">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: "No Partnership", desc: "Nothing in these Terms creates a partnership, joint venture, or agency relationship between you and UPTECH." },
                  { label: "Non-Solicitation", desc: "During membership and for 36 months after termination, you agree not to solicit or hire UPTECH employees, contractors, or personnel." },
                  { label: "Assignment", desc: "UPTECH may assign or transfer its rights and obligations. You may not assign or transfer without prior written consent." },
            ...
            <div className="rounded-2xl border border-[#D8D5CF] bg-white shadow-sm p-7">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: "Third-Party Links", desc: "Our website may contain links to third-party websites. UPTECH is not responsible for third-party content." },
                  ...
                  { label: "Amendments", desc: "UPTECH may update these Terms from time to time. Members will be notified of material changes; continued use constitutes acceptance." },
                ].map((item) => (
                  <li key={item.label} className="flex items-start gap-2.5">
                    <BadgeCheck className="w-4 h-4 text-[#22C55E] mt-0.5 flex-shrink-0" strokeWidth={2} />
                    <div>
                      <span className="font-semibold text-[#1C1F2E] text-sm">{item.label}</span>
                      <p className="text-[#5A5F72] text-xs mt-0.5">{item.desc}</p>
                    </div>
        ...
        <AnimatedSection>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#5A5F72] text-base leading-relaxed mb-8">
              ...
              <Link href="/code-of-conduct" className="text-[#2563EB] hover:underline">Code of Conduct</Link>, and{" "}
              <Link href="/arbitration/framework" className="text-[#2563EB] hover:underline">Arbitration Framework</Link>,
        ...
        <AnimatedSection>
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-[#5A5F72] text-sm leading-relaxed">
              ...
              <a href="mailto:info@ukpaktech.org.uk" className="text-[#2563EB] hover:underline">info@ukpaktech.org.uk</a>
            </p>
          </div>
        </AnimatedSection>
      </Section>
