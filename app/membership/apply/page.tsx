  ...
  return (
    <main className="relative min-h-screen bg-[#0B0F1A] text-white overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] rounded-full bg-purple-600/[0.04] blur-[120px]" />
      </div>
      ...
      {formSubmitted && (
        <section className="relative z-10 max-w-3xl mx-auto px-6 sm:px-8 -mt-8 mb-16">
          <motion.div
            ...
            className="bg-green-500/10 border border-green-500/20 rounded-2xl p-10 text-center backdrop-blur-sm"
          >
            <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-green-500/20 flex items-center justify-center">
              <CheckCircle2 className="w-10 h-10 text-green-400" />
            </div>
            <h2 className="text-2xl font-bold text-white mb-3">Application Submitted Successfully</h2>
            ...
            <Link
              href="/membership"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white/[0.06] border border-white/[0.1] rounded-lg text-white hover:bg-white/[0.1] transition-all"
            >
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 pb-24">
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <motion.div
              ...
              variants={fadeUp}
              className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 sm:p-10 backdrop-blur-sm"
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Membership Type</h2>
                  <p className="text-sm text-gray-500">Select the membership category that best fits your organisation</p>
                </div>
              </div>
                ...
                {membershipTiers.map((tier) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-gray-500 mt-0.5">{tier.fee}</span>
                    </div>
                  </label>
                ))}
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Information about your company or institution</p>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white placeholder:text-gray-600 focus:outline-none focus:border-blue-500/50 focus:bg-white/[0.06] transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      required
                      className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/[0.06] transition-all appearance-none"
                    >
                      <option value="" className="bg-[#131942]">Select country</option>
                      <option value="uk" className="bg-[#131942]">United Kingdom</option>
                      <option value="pakistan" className="bg-[#131942]">Pakistan</option>
                      <option value="other" className="bg-[#131942]">Other</option>
                    </select>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/[0.06] transition-all appearance-none">
                      <option value="" className="bg-[#131942]">Select range</option>
                      <option value="under-100k" className="bg-[#131942]">Under £100,000</option>
                      <option value="100k-500k" className="bg-[#131942]">£100,000 – £500,000</option>
                      <option value="500k-1m" className="bg-[#131942]">£500,000 – £1,000,000</option>
                      <option value="1m-5m" className="bg-[#131942]">£1,000,000 – £5,000,000</option>
                      <option value="5m-25m" className="bg-[#131942]">£5,000,000 – £25,000,000</option>
                      <option value="over-25m" className="bg-[#131942]">Over £25,000,000</option>
                      <option value="prefer-not" className="bg-[#131942]">Prefer not to say</option>
                    </select>
                    <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/[0.06] transition-all appearance-none">
                      <option value="" className="bg-[#131942]">Select range</option>
                      <option value="1-10" className="bg-[#131942]">1 – 10</option>
                      <option value="11-50" className="bg-[#131942]">11 – 50</option>
                      <option value="51-200" className="bg-[#131942]">51 – 200</option>
                      <option value="201-500" className="bg-[#131942]">201 – 500</option>
                      <option value="501-1000" className="bg-[#131942]">501 – 1,000</option>
                      <option value="over-1000" className="bg-[#131942]">Over 1,000</option>
                    </select>
                    <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white placeholder:text-gray-600 focus:outline-none focus:border-blue-500/50 focus:bg-white/[0.06] transition-all resize-none"
                  />
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/[0.06]">
                <p className="text-sm font-medium text-gray-300 mb-4">Listing Preferences</p>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Industry Sectors</h2>
                  <p className="text-sm text-gray-500">Select the sectors that best represent your organisation&apos;s activities</p>
                </div>
              </div>
                ...
                {sectors.map((sector) => (
                  ...
                  >
                    <input
                      ...
                      className="sr-only"
                    />
                    <span className={`w-3.5 h-3.5 rounded flex-shrink-0 border flex items-center justify-center ${selectedSectors.includes(sector) ? "bg-green-500 border-green-500" : "border-white/20"}`}>
                      {selectedSectors.includes(sector) && (
              ...
              <div className="mt-4">
                <label className="block text-sm font-medium text-gray-300 mb-2">Other (please specify)</label>
                <input
                  type="text"
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Select all cities where your organisation has offices</p>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="mt-3">
                  <input
                    ...
                    className="w-full sm:w-64 px-4 py-2.5 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white text-sm placeholder:text-gray-600 focus:outline-none focus:border-blue-500/50 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="mt-3">
                  <input
                    ...
                    className="w-full sm:w-64 px-4 py-2.5 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white text-sm placeholder:text-gray-600 focus:outline-none focus:border-green-500/50 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    min="0"
                    placeholder="0"
                    className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white placeholder:text-gray-600 focus:outline-none focus:border-green-500/50 focus:bg-white/[0.06] transition-all"
                  />
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Organisation Profile</h2>
                  <p className="text-sm text-gray-500">This profile will be used for the UPTECH membership directory (max 100 words)</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">CEO / Principal Representative</h2>
                  <p className="text-sm text-gray-500">Primary decision-maker for the organisation</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Main point of contact for UPTECH correspondence (if different from CEO)</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Secondary Contact (Optional)</h2>
                  <p className="text-sm text-gray-500">Additional point of contact for your organisation</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Main Contact in Pakistan (Optional)</h2>
                  <p className="text-sm text-gray-500">If your organisation has operations in Pakistan</p>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Pakistan Office Address</label>
                  <input
                    type="text"
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Referred By (Optional)</h2>
                  <p className="text-sm text-gray-500">If you were referred by an existing UPTECH member</p>
                </div>
              </div>

              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Referrer&apos;s Name</label>
                  <input
                    type="text"
            ...
            <motion.div
              ...
              viewport={{ once: true, margin: "-50px" }}
              variants={fadeUp}
              className="bg-gradient-to-b from-blue-500/[0.06] to-purple-500/[0.06] border border-white/[0.08] rounded-2xl p-8 sm:p-10 backdrop-blur-sm"
            >
