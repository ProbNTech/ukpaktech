...
const FeaturedPartnersCarousel = dynamic(() => import("@/components/FeaturedPartnersCarousel"), {
  loading: () => <div className="py-20 bg-white" aria-busy="true"><div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16"><div className="h-48 bg-[#f7f8fa] rounded-xl animate-pulse" /></div></div>,
});
  ...
  return (
    <div className="relative">
      ...
      <section className="relative py-20 lg:py-28 bg-white overflow-hidden" aria-labelledby="about-heading">
        ...
        <div className="relative max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
          <AnimatedSection animation="blur-in">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 w-24 h-24 rounded-xl bg-[#2563EB]/15 -z-10" aria-hidden="true" />
                <div className="absolute -top-4 -right-4 w-32 h-32 rounded-full bg-[#22C55E]/15 -z-10" aria-hidden="true" />
              </div>
            </div>
          </AnimatedSection>
        </div>
      ...
      {/* 6. IMPACT STATS + WHAT DRIVES US (combined dark block) */}
          ...
          <AnimatedSection animation="blur-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                return (
                  <Link key={card.title} href={card.href} className="group block bg-white rounded-xl border border-[#E5E7EB] p-6 lg:p-7 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <ArrowUpRight className="w-4 h-4 text-[#767370] group-hover:text-[#2563EB] transition-colors shrink-0 mt-1" />
                    </div>
      ...
      <section className="relative z-[1] py-14 lg:py-20 bg-[#0f1a3a] overflow-hidden" aria-labelledby="network-heading">
        <div className="absolute inset-0 opacity-[0.03]" aria-hidden="true" style={{ backgroundImage: "radial-gradient(circle, #fff 0.5px, transparent 0.5px)", backgroundSize: "32px 32px" }} />
        <div className="relative text-center max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
