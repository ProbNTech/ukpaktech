...
/* ── Purpose items ───────────────────────────────────────────────── */
const purposeItems = [
  { text: "Build trust in cross-border technology partnerships", color: "#2563EB" },
  { text: "Ensure quality and professional standards", color: "#22C55E" },
  { text: "Promote reliable Pakistani technology companies internationally", color: "#C41E3A" },
  { text: "Provide confidence to companies in the United Kingdom and European markets", color: "#2563EB" },
];
...
const benefits = [
  {
    ...
    description:
      "Companies can display the UPTECH Trusted Partner Certification badge on their website, marketing materials, and business profiles.",
  },
  {
    icon: Globe2,
    color: "#22C55E",
    ...
    description:
      "Certified companies will be featured in the UPTECH Global Technology Directory, accessible to businesses and investors across Europe.",
  },
  {
    icon: Briefcase,
    color: "#C41E3A",
  ...
  },
  {
    ...
    description:
      "Certification demonstrates that the company has passed UPTECH verification standards, increasing trust with international clients.",
  },
];
...
const criteria = [
  ...
  },
  {
    ...
    tagColors: ["#2563EB", "#22C55E", "#C41E3A", "#7C3AED", "#2563EB"],
  },
  {
    icon: Shield,
    color: "#C41E3A",
...
const processSteps = [
  ...
  },
  {
    ...
    title: "Evaluation",
    description:
      "UPTECH reviews the application based on technical expertise, business experience, and professional standards.",
  ...
  },
  {
    ...
    title: "Approval",
    description:
      "Successful companies are granted UPTECH Trusted Partner Certification and issued their verified badge.",
  ...
  },
  {
    ...
    title: "Listing",
    description:
      "Certified companies are listed in the UPTECH Global Technology Directory for international visibility.",
        ...
        <AnimatedSection>
          <div className="max-w-3xl">
            ...
            <p className="text-[#5A5F72] text-lg sm:text-xl leading-relaxed mb-4">
              UPTECH offers a Trusted Partner Certification programme designed to recognise Pakistani technology companies
            ...
            <p className="text-[#5A5F72] text-lg sm:text-xl leading-relaxed">
              Through the Trusted Partner Certification programme, UPTECH aims to create a reliable technology ecosystem
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-full bg-white rounded-2xl p-6 flex flex-col">
                    ...
                    <h3 className="font-heading font-bold text-[#1C1F2E] text-lg mb-2 group-hover:text-[#2563EB] transition-colors duration-200">{benefit.title}</h3>
        ...
        <AnimatedSection>
          <div className="max-w-2xl">
            ...
            <div className="flex items-start gap-4 bg-white rounded-2xl border border-[#D8D5CF]/60 p-6 shadow-sm">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "#2563EB15", border: "1px solid #2563EB30" }}>
                <CalendarClock className="w-5 h-5 text-[#2563EB]" strokeWidth={1.5} />
              </div>
              <div>
                ...
                <p className="text-[#5A5F72] text-base leading-relaxed">
                  ...
                  their certified status and continued listing in the UPTECH Global Technology Directory.
                </p>
              </div>
            </div>
          </div>
