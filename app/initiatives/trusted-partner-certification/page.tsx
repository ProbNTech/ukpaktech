...
export const metadata: Metadata = {
  ...
  description: "UPTECH Trusted Partner Certification recognises Pakistani technology companies that meet high standards of professionalism, reliability, and technical capability for global collaboration.",
};
