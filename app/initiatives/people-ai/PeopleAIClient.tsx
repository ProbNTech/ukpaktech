              ...
              {capabilities.map((cap, i) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true, margin: "-50px" }}
                    transition={{ duration: 0.4, delay: i * 0.08 }}
                    className="group relative backdrop-blur-md bg-white/[0.03] border border-white/[0.08] rounded-xl overflow-hidden hover:-translate-y-1 hover:border-white/[0.15] transition-all duration-300"
                  >
                    {/* Colored top border */}
                    <div
                        ...
                        <div className="relative">
                          ...
                          <div
                            ...
                            style={{
                              ...
                              boxShadow: `0 0 20px ${cap.color}10`,
                            }}
                          >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6 pl-7 flex items-start gap-5">
                      ...
                      <div className="relative flex-shrink-0">
                        ...
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: `0 0 20px ${useCase.color}10`,
                          }}
                        >
                      ...
                      <ArrowUpRight className="w-4 h-4 text-white/20 group-hover:text-[#2563EB] transition-colors duration-300 flex-shrink-0 mt-1" />
                    </div>
                  </motion.div>
                );
              })}
