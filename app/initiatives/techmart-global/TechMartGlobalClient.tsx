  ...
  return (
    <div className="bg-[#0B0F1A]">
          ...
          <AnimatedSection>
            <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-3">
                ...
                <h2 className="font-heading font-extrabold text-white text-3xl sm:text-4xl lg:text-5xl leading-tight mb-8">
                  What is TechMart Global?
                </h2>
              ...
              >
                <div className="relative backdrop-blur-md bg-white/[0.04] border border-white/[0.08] rounded-2xl overflow-hidden">
                  {/* Top gradient accent */}
                  <div
                  ...
                  />
                  {/* Glow effect */}
                  <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full bg-[#2563EB]/10 blur-[60px] pointer-events-none" />
              ...
              {audiences.map((audience, i) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true, margin: "-50px" }}
                    transition={{ duration: 0.4, delay: i * 0.08 }}
                    className="group relative backdrop-blur-md bg-white/[0.03] rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2"
                    style={{
                      border: `1px solid ${audience.color}20`,
                    }}
                  >
                    ...
                    <div
                      ...
                      style={{
                        boxShadow: `inset 0 0 0 1px ${audience.color}40, 0 0 30px ${audience.color}10`,
                      }}
                    />
                    {/* Top glow line */}
                    <div
                    ...
                    {/* Corner glow */}
                    <div
                      className="absolute -top-10 -right-10 w-32 h-32 rounded-full opacity-20 blur-[40px] pointer-events-none group-hover:opacity-40 transition-opacity duration-700"
      ...
      <section className="relative bg-[#131942]">
        ...
        />
        {/* Accent glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#2563EB]/5 blur-[120px] pointer-events-none" />
              ...
              {features.map((feature, i) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true, margin: "-50px" }}
                    transition={{ duration: 0.4, delay: i * 0.08 }}
                    className="group relative backdrop-blur-md bg-white/[0.03] rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-1"
                    style={{ border: `1px solid ${feature.color}15` }}
                  >
                    {/* Top glow line */}
                    <div
                      className="absolute top-0 left-0 right-0 h-[2px]"
                    ...
                    <div
                      className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                      style={{
                        boxShadow: `inset 0 0 0 1px ${feature.color}30, 0 0 40px ${feature.color}08`,
                      }}
                    />
                    ...
                    <div className="relative p-6 flex gap-5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="font-heading font-bold text-white text-base flex-1 pr-3">
                            {feature.title}
                          </h3>
                          <span
            ...
            <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
              ...
              >
                <div className="relative backdrop-blur-md bg-white/[0.04] border border-white/[0.08] rounded-2xl overflow-hidden">
                  ...
                  />
                  {/* Glow */}
                  <div className="absolute -top-16 -left-16 w-32 h-32 rounded-full bg-[#2563EB]/10 blur-[50px] pointer-events-none" />
                  ...
                  <div className="relative p-8 pl-6">
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <h3 className="font-heading font-bold text-white text-base">UK Entry Pathway</h3>
                    </div>
                    <div className="h-px bg-white/10 mb-5" />
      ...
      <section className="relative bg-[#0B0F1A]">
        ...
        />
        {/* Accent glow */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[250px] bg-[#22C55E]/5 blur-[100px] pointer-events-none" />
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                      style={{
                        boxShadow: `inset 0 0 0 1px ${step.color}30, 0 0 30px ${step.color}08`,
                      }}
                    />
                    ...
                    <div className="relative p-6">
                      ...
                      <div className="flex items-center justify-between mb-5">
                        ...
                        <div className="relative">
                          <div
                            className="absolute inset-[-4px] rounded-full blur-md opacity-40 group-hover:opacity-70 transition-opacity duration-500"
      ...
      <section className="relative bg-[#131942]">
        ...
        />
        {/* Accent glow */}
        <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[300px] h-[400px] bg-[#8b5cf6]/5 blur-[100px] pointer-events-none" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                        style={{
                          boxShadow: `inset 0 0 0 1px ${item.color}25, 0 0 25px ${item.color}06`,
                        }}
                      />
                      ...
                      <div className="relative p-5 pl-5 flex items-start gap-4">
                        <div className="relative flex-shrink-0">
                          <div
                            className="absolute inset-[-6px] rounded-xl opacity-0 group-hover:opacity-40 blur-lg transition-opacity duration-500"
