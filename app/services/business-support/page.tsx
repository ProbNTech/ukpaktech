        ...
        <AnimatedSection>
          <div className="max-w-3xl">
            ...
            <p className="text-[#3D4152] text-base leading-relaxed mb-5">
              Starting and scaling a business involves navigating a complex landscape of legal, financial, and operational requirements. UPTECH&apos;s Business Support Services remove the friction — giving you access to trusted professionals and streamlined processes so you can focus on building your product and growing your business.
            </p>
            <p className="text-[#3D4152] text-base leading-relaxed">
              Whether you&apos;re registering a company, protecting intellectual property, preparing for investment, or managing compliance — our team and partners are here to help at every stage.
            </p>
          </div>
        </AnimatedSection>
      </Section>
        ...
        <AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => {
              ...
              return (
                <div key={service.title} className="bg-white border border-[#D8D5CF] rounded p-6 flex flex-col hover:border-[#2563EB]/40 transition-colors duration-300">
        ...
        <AnimatedSection>
          <div className="max-w-3xl">
            ...
            <p className="text-white/70 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">
              Whether you&apos;re registering a company, protecting IP, or preparing for investment — our team and partners are here to help you build on solid foundations.
            </p>
