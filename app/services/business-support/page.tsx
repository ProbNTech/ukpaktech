...
export default function BusinessSupportPage() {
  ...
  return (
    <div className="bg-[#0B0F1A]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 relative z-10">
          <AnimatedSection>
            <div className="mb-14">
              ...
              <p className="text-white/40 text-base sm:text-lg max-w-2xl leading-relaxed">Seven core business support services covering the full startup lifecycle.</p>
            </div>
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      <div className="relative mb-5">
                        <div className="absolute inset-[-8px] rounded-xl opacity-0 group-hover:opacity-40 blur-xl transition-opacity duration-500" style={{ background: service.color }} />
                        <div className="relative w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: `${service.color}15`, border: `1px solid ${service.color}30`, boxShadow: `0 0 20px ${service.color}10` }}>
                          <Icon className="w-5 h-5" style={{ color: service.color }} strokeWidth={1.5} />
                        </div>
                      </div>
                      <h3 className="font-heading font-bold text-white text-base mb-2 group-hover:text-[#2563EB] transition-colors duration-200">{service.title}</h3>
                      <div className="h-px bg-white/10 mb-3" />
                      <p className="text-sm text-white/50 leading-relaxed mb-4 flex-1">{service.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 relative z-10">
          <AnimatedSection>
            <div className="mb-14">
              ...
              <p className="text-white/40 text-base sm:text-lg max-w-2xl leading-relaxed">A simple, structured process from consultation to ongoing support.</p>
            </div>
      ...
      <section className="relative bg-[#0B0F1A]">
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='%23ffffff' stroke-width='0.5'%3E%3Cpath d='M0 0h60v60H0z'/%3E%3C/g%3E%3C/svg%3E\")" }} />
        <div className="absolute bottom-0 left-0 w-72 h-72 rounded-full blur-[120px] opacity-10 bg-[#f59e0b]" />
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 relative z-10">
          <AnimatedSection>
            <div className="mb-14">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#f59e0b] mb-4">Advantages</p>
              <h2 className="font-heading font-extrabold text-white text-3xl sm:text-4xl lg:text-5xl leading-tight mb-4">Why Choose UPTECH</h2>
              <div className="h-1 w-16 rounded-full bg-gradient-to-r from-[#f59e0b] to-[#f59e0b]/40 mb-4" />
              <p className="text-white/40 text-base sm:text-lg max-w-2xl leading-relaxed">What makes our business support services different.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 relative z-10">
          <AnimatedSection>
            <div className="mb-14">
              ...
              <p className="text-white/40 text-base sm:text-lg max-w-2xl leading-relaxed">Common questions about our business support services.</p>
            </div>
