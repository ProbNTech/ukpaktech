...
/* ── Stats ── */
const stats = [
  { value: "5", label: "Research Verticals", color: "#2563EB" },
  { value: "30–50%", label: "Cost Savings vs Europe", color: "#22C55E" },
  { value: "70,000+", label: "IT & Engineering Grads/Year", color: "#C41E3A" },
  { value: "15+", label: "Countries Served", color: "#2563EB" },
];
...
const faqs = [
  ...
  { question: "How do we get started with UPTECH research services?", answer: "Simply contact us or become a member to discuss your research needs. We will match you with the right research professionals and set up a structured collaboration framework tailored to your requirements." },
];
  ...
  return (
    <div>
          ...
          <AnimatedSection>
            <div>
              ...
              <p className="text-[#5A5F72] text-lg sm:text-xl leading-relaxed mb-4">
                UPTECH acts as a bridge connecting Pakistani technology companies, research institutions, and professionals with businesses and innovation ecosystems across the UK and Europe. Our services are designed to facilitate technology collaboration, market access, and research partnerships.
              </p>
      ...
      <GlobalCTA
        ...
        subtitle="Partner with UPTECH to access high-quality, cost-effective research services from Pakistan. Join our network and unlock innovation at scale."
