        ...
        <div className="max-w-7xl mx-auto px-6 py-14 lg:py-20">
          <AnimatedSection>
            <div className="max-w-3xl">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#2563EB] mb-4">Your one-stop shop</p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 lg:py-20 relative z-10">
          <AnimatedSection>
            <div className="mb-8">
              ...
              <p className="text-[#7A7E8F] text-lg sm:text-xl max-w-2xl leading-relaxed">Everything you need to grow, all in one place.</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 lg:py-20 relative z-10">
          <AnimatedSection>
            <div className="mb-8">
              ...
              <p className="text-[#7A7E8F] text-lg sm:text-xl max-w-2xl leading-relaxed">Helping tech SMEs grow across key global markets.</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 lg:py-20 relative z-10">
          <AnimatedSection>
            <div className="mb-8">
              ...
              <p className="text-[#7A7E8F] text-lg sm:text-xl max-w-2xl leading-relaxed">A structured pathway from onboarding to scaling your business internationally.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 lg:py-20 relative z-10">
          <AnimatedSection>
            <div className="mb-8">
              ...
              <div className="h-1 w-16 rounded-full bg-gradient-to-r from-[#2563EB] to-[#2563EB]/40 mb-4" />
              <p className="text-[#7A7E8F] text-lg sm:text-xl max-w-2xl leading-relaxed">SME Hub is built for technology companies at every growth stage.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 lg:py-20 relative z-10">
          <AnimatedSection>
            <div className="mb-8">
              ...
              <div className="h-1 w-16 rounded-full bg-gradient-to-r from-[#C41E3A] to-[#C41E3A]/40 mb-4" />
              <p className="text-[#7A7E8F] text-lg sm:text-xl max-w-2xl leading-relaxed">Common questions about the SME Hub.</p>
            </div>
