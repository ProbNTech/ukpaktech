...
const stats = [
  { value: "75+", label: "Active Mentors", color: "#2563EB" },
  { value: "200+", label: "Startups Mentored", color: "#22C55E" },
  { value: "12", label: "Countries Represented", color: "#C41E3A" },
  { value: "92%", label: "Founder Satisfaction", color: "#2563EB" },
];
...
const processSteps = [
  { number: "01", title: "Apply", color: "#2563EB", description: "Submit your application with your expertise, industry background, and areas where you can add the most value.", outcome: "Application reviewed" },
  { number: "02", title: "Onboard", color: "#22C55E", description: "Complete our mentor onboarding including orientation, toolkit access, and introduction to the current cohort.", outcome: "Mentor activated" },
  { number: "03", title: "Match", color: "#C41E3A", description: "We match you with startups based on your expertise, industry focus, and the startup\u2019s specific needs.", outcome: "Startup matched" },
  { number: "04", title: "Mentor", color: "#22C55E", description: "Begin your mentoring journey \u2014 guiding founders through challenges, strategy, and growth.", outcome: "Impact delivered" },
];

const mentorProfiles = [
  { title: "Technology Leaders", description: "CTOs, VPs of Engineering, and technical founders with deep product and engineering expertise.", icon: Target, color: "#2563EB" },
  { title: "Business Strategists", description: "CEOs, Managing Directors, and strategy consultants with scaling and market entry experience.", icon: Compass, color: "#C41E3A" },
  { title: "Investment Experts", description: "VCs, angel investors, and fund managers who understand fundraising from both sides.", icon: Award, color: "#22C55E" },
  { title: "Domain Specialists", description: "Industry experts in FinTech, HealthTech, EdTech, AI, and other high-growth sectors.", icon: Globe, color: "#2563EB" },
];
