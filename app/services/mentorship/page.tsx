...
export default function MentorshipPage() {
  ...
  return (
    <div className="bg-[#0B0F1A]">
      ...
      {/* ================================================================
          INTRO + SIDEBAR - Dark background with glass sidebar
          ================================================================ */}
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20 py-20 lg:py-28">
          <AnimatedSection>
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              {/* Sidebar -- What Mentors Provide (Dark glass card) */}
              <div className="lg:col-span-2">
                <div className="backdrop-blur-md bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 sticky top-8">
                  {/* Subtle top glow */}
                  <div className="absolute -top-px left-8 right-8 h-[1px] bg-gradient-to-r from-transparent via-[#2563EB]/50 to-transparent" />
                  <h3 className="font-heading font-bold text-white text-base mb-5">What Mentors Provide</h3>
                    ...
                    {sidebarItems.map((item, i) => (
                      ...
                      >
                        ...
                        <div className="relative flex-shrink-0 mt-0.5">
                          <div
                            className="absolute inset-[-6px] rounded-xl blur-lg transition-opacity duration-300"
                            style={{ background: item.color, opacity: 0.1 }}
                          />
                          <div
      ...
      {/* ================================================================
          ADVANTAGES - Dark glass cards with colored glow borders
          ================================================================ */}
      ...
      {/* ================================================================
          MENTOR ROLES - Premium dark glass with strong visual separation
          ================================================================ */}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {mentorRoles.map((role, i) => {
                ...
                return (
                  <motion.div
                    key={role.title}
                    className="group relative backdrop-blur-md bg-white/[0.04] rounded-2xl border border-white/[0.08] p-8 hover:-translate-y-1 transition-all duration-500 overflow-hidden"
                    initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 16 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: i * 0.1 }}
                  >
                    ...
                    <div
                      className="absolute -inset-[1px] rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                      style={{
                        background: `linear-gradient(135deg, ${role.color}25, transparent 40%, transparent 60%, ${role.color}15)`,
                      }}
                    />
                    {/* Glow orb behind card */}
                    <div
                      className="absolute -top-20 -right-20 w-48 h-48 rounded-full blur-[80px] opacity-0 group-hover:opacity-15 transition-opacity duration-500 pointer-events-none"
                    ...
                    <div className="relative z-[1]">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="font-heading font-bold text-xl text-white">{role.title}</h3>
                          <div
      ...
      {/* ================================================================
          PROCESS STEPS - Numbered glowing circles
          ================================================================ */}
      <section className="relative bg-[#0B0F1A] overflow-hidden">
      ...
      {/* ================================================================
          MENTOR PROFILES - Dark glass cards with colored left accents
          ================================================================ */}
      <section className="relative bg-[#0E1221] overflow-hidden">
          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {mentorProfiles.map((item, i) => (
                <motion.div
                  key={item.title}
                  className="group relative backdrop-blur-md bg-white/[0.03] rounded-2xl border border-white/[0.06] p-6 pl-8 hover:-translate-y-1 transition-all duration-500 overflow-hidden"
                  initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 16 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: i * 0.1 }}
                >
                  ...
                  {/* Glow on hover */}
                  <div
                    className="absolute -left-8 top-1/2 -translate-y-1/2 w-16 h-32 rounded-full blur-[40px] opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none"
                    style={{ background: item.color }}
                  />
      ...
      {/* ================================================================
          FAQ - Dark glass accordion cards with colored numbered badges
          ================================================================ */}
      <section className="relative bg-[#131942] overflow-hidden">
        <div
          className="absolute inset-0 opacity-[0.015]"
...
/* ================================================================
   FAQ Accordion Component - Dark glass cards
   ================================================================ */
    ...
    <div className="space-y-4">
      {faqs.map((faq, index) => {
        ...
        return (
          <motion.div
            key={faq.question}
            className="group relative backdrop-blur-md bg-white/[0.03] rounded-2xl border border-white/[0.06] overflow-hidden transition-all duration-300"
              ...
              {isOpen && (
                ...
                >
                  <div className="px-6 pb-5 pl-[4.75rem]">
                    <div className="h-px bg-white/10 mb-4" />
                    <p className="text-white/50 text-sm leading-[1.8]">{faq.answer}</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
