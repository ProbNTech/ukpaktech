...
const whyChooseUs = [
  { icon: Handshake, title: "Strategic Connections", description: "We ensure that every event brings together the right founders and the right investors who can help them scale." },
  ...
  { icon: BarChart3, title: "Proven Results", description: "Our track record of funding success speaks for itself." },
...
const processSteps = [
  { number: "01", title: "Discovery", description: "We learn about your business, goals, target markets, and growth stage to understand your needs.", outcome: "Tailored profile created", icon: Search },
  { number: "02", title: "Matching", description: "Using our database and network intelligence, we identify the most relevant connections for your business.", outcome: "Curated shortlist prepared", icon: GitBranch },
  { number: "03", title: "Introduction", description: "We facilitate warm introductions through events, meetings, or direct outreach to matched partners.", outcome: "Meetings arranged", icon: MessageSquare },
  { number: "04", title: "Follow-Through", description: "We track outcomes, facilitate follow-ups, and ensure connections translate into tangible business results.", outcome: "Deals tracked & supported", icon: TrendingUp },
];
      ...
      <Section variant="alt">
        <AnimatedSection>
          <SectionHeader
            label="Advantages"
            title="Why Choose Us"
            subtitle="Five reasons organisations trust UPTECH to build their international network."
          />
              ...
              return (
                <div key={step.number} className="border-t-2 border-[#2563EB] pt-5">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs font-bold text-[#2563EB] tabular-nums">{step.number}</span>
                    <Icon className="w-5 h-5 text-[#3D4152]" />
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <SectionHeader
                ...
                title="Our Partners"
                subtitle="We proudly collaborate with:"
              />
