...
export const countryData: Record<string, CountryMarketData> = {
  uk: {
    ...
    sectors: [
      {
        ...
        currentMarket: "USD 15–20 bn",
        forecast: "USD 50–60 bn by 2030",
        opportunities:
      ...
      },
      {
        ...
        currentMarket: "£21 bn (~USD 28 bn, 2025)",
        forecast: "£1 trillion AI economy by 2035",
        opportunities:
    ...
    growthDrivers: [
      ...
      "Rising data centre investment (projected growth to £10 billion annually by 2029)",
    ...
    detailedSections: [
      ...
      },
      {
        title: "Cybersecurity",
        content:
          "The UK is Europe's largest cybersecurity market, with revenue estimated at about €10.36 billion (USD 11 billion) in 2025, expected to grow at around 6.3% CAGR (2025–2030).",
      },
      {
        title: "IT Services",
        content:
  ...
  germany: {
    ...
    detailedSections: [
      ...
      },
      {
        title: "Artificial Intelligence",
        content:
          "Germany's AI market is estimated at about €9.04 billion (USD 9.96 billion) in 2025 with strong adoption in industry sectors. Broader European AI growth suggests significant expansion by 2030.",
      },
      {
        title: "Cybersecurity",
        content:
    ...
    sectors: [
      {
        ...
        currentMarket: "$80–90 bn (total turnover)",
  ...
  switzerland: {
    ...
    sectors: [
      ...
      },
      {
        ...
        forecast: "USD 4.7 bn by mid-2030s (6.5–7% CAGR)",
        opportunities:
  ...
  "baltic-states": {
    ...
    sectors: [
      {
        sector: "Estonia – ICT Sector",
        currentMarket: "€10 bn ICT; software €3.3–3.5 bn; IT services €6.1 bn",
      ...
      {
        sector: "Lithuania – Software & SaaS",
        currentMarket: "€3.5 bn software dev; USD 138.9M SaaS (2025)",
      ...
      {
        sector: "Latvia – ICT & Cloud",
        currentMarket: "USD 6.5 bn ICT; IT services USD 292M (2025)",
        forecast: "Public cloud: USD 628.8M by 2030 (22.9% CAGR); Software: €1.7 bn (2025)",
        opportunities:
    ...
    growthDrivers: [
      ...
      "Latvia: Strong ICT exports exceeding €1 billion annually",
    ...
    detailedSections: [
      {
        ...
        content:
          "Estonia's ICT sector accounts for approximately 9-11% of national GDP. Industry turnover is around €10 billion, with more than half from international clients. The public cloud market projected to reach USD 499 million by 2030 at 22.7% CAGR. Estonia's FinTech sector valued at around €15.2 billion with 260+ fintech startups.",
      },
      {
        title: "Lithuania - Balanced Tech Ecosystem",
        content:
          "Lithuania's software development industry is estimated at about €3.5 billion in 2025. SaaS market expected to reach USD 384 million by 2030 (22.6% CAGR). The country hosts 3 unicorns and over 1,000 tech companies, with ICT employment surging roughly 80% since 2020.",
      },
      {
        title: "Latvia - Export-Oriented ICT Hub",
        content:
          "Latvia's ICT sector contributed about 6.7% of GDP in 2024, with total turnover estimated around USD 6.5 billion. Digital exports exceed €1 billion annually. Public cloud projected to grow from USD 224.3 million in 2025 to USD 628.8 million by 2030 (22.9% CAGR). Over 7,000 ICT companies operate domestically.",
      },
    ],
  },
};
...
export const europeWideData: MarketSector[] = [
  {
    sector: "Enterprise IT & ERP",
    currentMarket: "Germany & UK: USD 30–40 bn",
    forecast: "Growth 10% CAGR",
    opportunities:
...
export const pakistanITScope: PakistanScopeItem[] = [
  {
    ...
    marketGrowth: "AI adoption across European enterprises: 10–20% CAGR",
    whyPakistanFits: [
  ...
  },
  {
    ...
    marketGrowth: "Cloud & digital transformation: 12–17% CAGR to 2030",
    whyPakistanFits: [
  ...
  },
  {
    ...
    marketGrowth: "Cybersecurity sector: 8–11% CAGR across Europe",
    whyPakistanFits: [
  ...
  },
  {
    ...
    marketGrowth: "IT services market: 6–13% CAGR across European countries",
    whyPakistanFits: [
...
export const pakistanTalentSections = {
  ...
  costAdvantage: {
    ...
    comparisons: [
      { role: "Senior Software Engineer", saving: "40–60% lower cost than Europe" },
      { role: "Development Teams", saving: "30–50% lower operational cost" },
    ],
  ...
  exports: {
    ...
    stats: [
      ...
      "Potential to reach $15–18 billion in IT exports",
    ],
  },
  collaboration: {
