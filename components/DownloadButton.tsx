...
export function DownloadButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center font-semibold rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:ring-offset-2 ${variantStyles[variant]} ${sizeStyles[size]} ${className}`}
    >
