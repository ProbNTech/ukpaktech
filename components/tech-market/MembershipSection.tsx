              ...
              {[
                {
                  ...
                  image: "/image/who-can-join/IT_Companies.webp",
                  icon: Cpu,
                  color: "#2563EB",
                },
                {
                  ...
                  image: "/image/who-can-join/Investors_VCs.webp",
                  icon: TrendingUp,
                  color: "#22C55E",
                },
                {
                  ...
                  image: "/image/who-can-join/Academic_Research.webp",
                  icon: GraduationCap,
                  color: "#EAB308",
                },
                {
                  ...
                  image: "/image/who-can-join/Individual_Professionals.webp",
                  icon: Users,
                  color: "#C41E3A",
                },
              ].map((item) => {
