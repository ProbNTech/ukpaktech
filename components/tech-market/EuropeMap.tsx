...
const nodes: MarketNode[] = [
  { slug: "uk", name: "United Kingdom", flag: "/image/flags/gb.svg", x: 16, y: 32, color: "#3B82F6", marketValue: "$200B+", marketBillion: 200, growth: "7.2%", topSector: "AI & Cloud" },
  ...
  { slug: "germany", name: "Germany", flag: "/image/flags/de.svg", x: 52, y: 35, color: "#22C55E", marketValue: "$120B+", marketBillion: 120, growth: "5.8%", topSector: "Enterprise IT" },
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <p className="text-sm font-bold text-[#22C55E]">{node.growth}</p>
                </div>
                <div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute w-[350px] h-[350px] rounded-full" style={{ top: "30%", left: "45%", background: "radial-gradient(circle, rgba(34,197,94,0.06) 0%, transparent 60%)" }} />
      </div>
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none z-[1]">
        ...
        {[
          { cx: "88%", cy: "45%", r: 1.5, color: "#3B82F6", delay: 0 },
          { cx: "92%", cy: "60%", r: 1, color: "#22C55E", delay: 1 },
