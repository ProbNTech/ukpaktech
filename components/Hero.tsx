      ...
      <div className="relative z-20 flex items-center lg:h-screen px-6 sm:px-10 lg:px-16 xl:px-20 pt-14 sm:pt-16 lg:pt-0 pb-14 lg:pb-0">
        <div className="relative w-full max-w-full lg:max-w-[55%]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <p
                className="text-lg sm:text-xl md:text-2xl font-extrabold uppercase tracking-[0.18em] text-[#C41E3A] mb-4 sm:mb-5"
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-500 ${
              index === currentIndex ? "bg-[#22C55E] w-8" : "bg-white/40 w-2 hover:bg-white/60"
            }`}
          />
        ))}
      </div>
