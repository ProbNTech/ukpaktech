...
export function FooterContactForm() {
  ...
  const inputClass =
    "w-full bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg px-3.5 py-2.5 text-white text-sm placeholder-white/60 outline-none transition-all duration-300 focus:bg-white/15 focus:border-[#22C55E] focus:ring-2 focus:ring-[#22C55E]/30";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      {state === "error" && errorMsg && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#E11D48]/20 border border-[#E11D48]/40 text-sm text-white">
