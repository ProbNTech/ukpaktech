          ...
          <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4">
            <div
              className="
                ...
                rounded-full bg-[#2563EB]/10 flex items-center justify-center flex-shrink-0
              "
            >
              <svg
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
            <button
              ...
              className="
                ...
                px-5 sm:px-6
                rounded-full bg-[#2563EB] text-white font-semibold
                text-xs sm:text-sm lg:text-[15px]
                hover:bg-[#1d4ed8] active:scale-[0.98] transition-all cursor-pointer
              "
            >
              Accept All
            </button>
            <button
              ...
              className="
                ...
                hover:border-[#2563EB] hover:text-[#2563EB] active:scale-[0.98] transition-all cursor-pointer
              "
            >
              Reject All
            </button>
