  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#0B0F1A] rounded-2xl border border-white/[0.08] overflow-hidden shadow-2xl shadow-black/20">
        ...
        {/* Corner glow accents */}
        <div className="absolute top-0 right-0 w-64 h-64 opacity-[0.04]" style={{ background: "radial-gradient(circle at 100% 0%, #2563EB, transparent 60%)" }} />
        <div className="absolute bottom-0 left-0 w-64 h-64 opacity-[0.04]" style={{ background: "radial-gradient(circle at 0% 100%, #8b5cf6, transparent 60%)" }} />
        ...
        <div className="relative px-7 pt-8 pb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <motion.div variants={itemVariants}>
              <label
                htmlFor="name"
                className={`block text-[10px] font-bold tracking-[0.18em] uppercase mb-2.5 transition-colors duration-300 ${focusedField === "name" ? "text-[#2563EB]" : "text-white/40"}`}
              >
                Full Name <span className="text-[#C41E3A]">*</span>
              </label>
              <div className="relative group">
                <div className={`absolute inset-0 rounded-xl transition-all duration-500 ${focusedField === "name" ? "shadow-[0_0_20px_rgba(37,99,235,0.15)]" : ""}`} />
                ...
                <User className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-300 ${focusedField === "name" ? "text-[#2563EB]" : "text-white/20"}`} />
                <input
                  id="name"
                  name="name"
                  type="text"
            ...
            <motion.div variants={itemVariants}>
              <label
                htmlFor="email"
                className={`block text-[10px] font-bold tracking-[0.18em] uppercase mb-2.5 transition-colors duration-300 ${focusedField === "email" ? "text-[#2563EB]" : "text-white/40"}`}
              >
                Email Address <span className="text-[#C41E3A]">*</span>
              </label>
              <div className="relative group">
                <div className={`absolute inset-0 rounded-xl transition-all duration-500 ${focusedField === "email" ? "shadow-[0_0_20px_rgba(37,99,235,0.15)]" : ""}`} />
                ...
                <Mail className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-300 ${focusedField === "email" ? "text-[#2563EB]" : "text-white/20"}`} />
                <input
                  id="email"
                  name="email"
                  type="email"
        ...
        <div className="relative px-7 pb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <motion.div variants={itemVariants}>
              <label
                htmlFor="phone"
                className={`block text-[10px] font-bold tracking-[0.18em] uppercase mb-2.5 transition-colors duration-300 ${focusedField === "phone" ? "text-[#22C55E]" : "text-white/40"}`}
              >
                Phone
              </label>
              <div className="relative group">
                ...
                <Phone className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-300 ${focusedField === "phone" ? "text-[#22C55E]" : "text-white/20"}`} />
                <input
                  id="phone"
                  name="phone"
                  type="tel"
            ...
            <motion.div variants={itemVariants}>
              <label
                ...
                className={`block text-[10px] font-bold tracking-[0.18em] uppercase mb-2.5 transition-colors duration-300 ${focusedField === "organisation" ? "text-[#22C55E]" : "text-white/40"}`}
              >
                Organisation
              </label>
              <div className="relative group">
                ...
                <Building2 className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-300 ${focusedField === "organisation" ? "text-[#22C55E]" : "text-white/20"}`} />
                <input
                  id="organisation"
                  name="organisation"
                  type="text"
            ...
            <motion.div variants={itemVariants}>
              <label
                htmlFor="enquiryType"
                className={`block text-[10px] font-bold tracking-[0.18em] uppercase mb-2.5 transition-colors duration-300 ${focusedField === "enquiryType" ? "text-[#22C55E]" : "text-white/40"}`}
              >
              ...
              <div className="relative group">
                ...
                <MessageSquare className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-300 ${focusedField === "enquiryType" ? "text-[#22C55E]" : "text-white/20"}`} />
                <ChevronDown className={`absolute right-3.5 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none transition-colors duration-300 ${focusedField === "enquiryType" ? "text-[#22C55E]" : "text-white/15"}`} />
                <select
                  id="enquiryType"
                  name="enquiryType"
                  required
        ...
        <div className="relative px-7 pb-7">
          ...
          <motion.div variants={itemVariants}>
            <label
              htmlFor="message"
              className={`block text-[10px] font-bold tracking-[0.18em] uppercase mb-2.5 transition-colors duration-300 ${focusedField === "message" ? "text-[#8b5cf6]" : "text-white/40"}`}
            >
              Message <span className="text-[#C41E3A]">*</span>
            </label>
            <div className="relative group">
              <div className={`absolute inset-0 rounded-xl transition-all duration-500 ${focusedField === "message" ? "shadow-[0_0_20px_rgba(139,92,246,0.1)]" : ""}`} />
              ...
              <MessageSquare className={`absolute left-3.5 top-4 w-4 h-4 transition-colors duration-300 ${focusedField === "message" ? "text-[#8b5cf6]" : "text-white/20"}`} />
              <textarea
                id="message"
                name="message"
                required
