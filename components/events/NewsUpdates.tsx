    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {items.map((item, index) => (
        <motion.article
          ...
          className="group"
        >
          <div className="relative h-full bg-white border border-[#D8D5CF] hover:border-[#2563EB]/40 transition-colors duration-200 p-6 flex flex-col">
            {/* Category */}
            ...
            {/* Title */}
            <h3 className="font-heading font-bold text-lg mb-3 text-[#1C1F2E] group-hover:text-[#2563EB] transition-colors duration-200 line-clamp-2 leading-snug">
              {item.title}
            </h3>
