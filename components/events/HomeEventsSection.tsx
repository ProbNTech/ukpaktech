            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="relative">
                <select
                  ...
                  className="appearance-none pl-4 pr-10 py-2.5 text-sm font-semibold rounded-lg border border-[#B0ADA6] bg-white text-[#3D4152] cursor-pointer hover:border-[#2563EB] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50"
                >
          ...
          {filtered.length > 0 ? (
            ...
            <div className="text-center py-12 text-[#3D4152] mb-10" role="status" aria-live="polite">
              ...
              <button
                ...
                className="mt-3 px-4 py-2 text-sm font-semibold text-[#2563EB]"
              >
                Clear filters
              </button>
            </div>
