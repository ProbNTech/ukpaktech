...
const BRAND_COLORS = [
  { color: "#2563EB", glow: "rgba(37,99,235,0.4)", bg: "rgba(37,99,235,0.15)", border: "rgba(37,99,235,0.30)" },
  { color: "#22C55E", glow: "rgba(34,197,94,0.4)", bg: "rgba(34,197,94,0.15)", border: "rgba(34,197,94,0.30)" },
  { color: "#C41E3A", glow: "rgba(196,30,58,0.4)", bg: "rgba(196,30,58,0.15)", border: "rgba(196,30,58,0.30)" },
