...
export const AITechIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <filter id="aiShadow"><feDropShadow dx="0" dy="4" stdDeviation="6" floodColor="#1D4ED8" floodOpacity="0.3"/></filter>
    </defs>
    {/* Circuit board base */}
    <rect x="30" y="110" width="140" height="60" rx="8" fill="url(#ai1)" filter="url(#aiShadow)"/>
    <rect x="35" y="115" width="130" height="50" rx="5" fill="#1E40AF" opacity="0.6"/>
    {/* Circuit traces */}
    <line x1="50" y1="130" x2="90" y2="130" stroke="#60A5FA" strokeWidth="2" opacity="0.6"/>
    <line x1="110" y1="130" x2="150" y2="130" stroke="#60A5FA" strokeWidth="2" opacity="0.6"/>
    <line x1="70" y1="145" x2="130" y2="145" stroke="#60A5FA" strokeWidth="1.5" opacity="0.4"/>
    <line x1="50" y1="155" x2="80" y2="155" stroke="#60A5FA" strokeWidth="1.5" opacity="0.4"/>
    <line x1="120" y1="155" x2="150" y2="155" stroke="#60A5FA" strokeWidth="1.5" opacity="0.4"/>
    {/* Circuit dots */}
    <circle cx="90" cy="130" r="3" fill="#93C5FD"/>
    <circle cx="110" cy="130" r="3" fill="#93C5FD"/>
    <circle cx="70" cy="145" r="2.5" fill="#60A5FA"/>
    <circle cx="130" cy="145" r="2.5" fill="#60A5FA"/>
    {/* Main CPU chip */}
    ...
    <circle cx="92" cy="80" r="2" fill="#BFDBFE"/>
    <circle cx="104" cy="78" r="1.5" fill="#BFDBFE"/>
    <circle cx="98" cy="88" r="2" fill="#BFDBFE"/>
    {/* Chip pins top */}
    <rect x="68" y="42" width="6" height="12" rx="2" fill="#60A5FA"/>
    <rect x="82" y="42" width="6" height="12" rx="2" fill="#60A5FA"/>
    <rect x="96" y="42" width="6" height="12" rx="2" fill="#60A5FA"/>
    <rect x="110" y="42" width="6" height="12" rx="2" fill="#60A5FA"/>
    {/* Chip pins bottom */}
    <rect x="68" y="116" width="6" height="12" rx="2" fill="#60A5FA"/>
    <rect x="82" y="116" width="6" height="12" rx="2" fill="#60A5FA"/>
    <rect x="96" y="116" width="6" height="12" rx="2" fill="#60A5FA"/>
    <rect x="110" y="116" width="6" height="12" rx="2" fill="#60A5FA"/>
    {/* Chip pins left */}
    <rect x="43" y="62" width="16" height="6" rx="2" fill="#60A5FA"/>
    <rect x="43" y="76" width="16" height="6" rx="2" fill="#60A5FA"/>
    <rect x="43" y="90" width="16" height="6" rx="2" fill="#60A5FA"/>
    {/* Chip pins right */}
    <rect x="141" y="62" width="16" height="6" rx="2" fill="#60A5FA"/>
    <rect x="141" y="76" width="16" height="6" rx="2" fill="#60A5FA"/>
    <rect x="141" y="90" width="16" height="6" rx="2" fill="#60A5FA"/>
    {/* Floating data particles */}
    <circle cx="30" cy="40" r="4" fill="#60A5FA" opacity="0.7"/>
    <circle cx="170" cy="35" r="3" fill="#93C5FD" opacity="0.6"/>
    <circle cx="25" cy="85" r="2.5" fill="#3B82F6" opacity="0.5"/>
    <circle cx="175" cy="90" r="3.5" fill="#60A5FA" opacity="0.5"/>
    {/* Signal waves */}
    <path d="M20 55c5-3 10 3 15 0" stroke="#93C5FD" strokeWidth="1.5" opacity="0.4" fill="none"/>
    <path d="M165 50c5-3 10 3 15 0" stroke="#93C5FD" strokeWidth="1.5" opacity="0.4" fill="none"/>
    {/* Stars */}
...
export const ServicesIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Laptop base */}
    <path d="M25 150l10-8h130l10 8v5H25v-5z" fill="#16A34A" opacity="0.6"/>
    ...
    <rect x="52" y="82" width="45" height="25" rx="2" fill="#22C55E" opacity="0.2"/>
    <rect x="52" y="82" width="45" height="6" rx="2" fill="#4ADE80" opacity="0.4"/>
    <rect x="103" y="82" width="45" height="25" rx="2" fill="#22C55E" opacity="0.2"/>
    ...
    {/* Lower screen rows */}
    <rect x="52" y="112" width="96" height="4" rx="1" fill="#22C55E" opacity="0.15"/>
    <rect x="52" y="119" width="96" height="4" rx="1" fill="#22C55E" opacity="0.15"/>
    <rect x="52" y="126" width="70" height="4" rx="1" fill="#22C55E" opacity="0.15"/>
    {/* Floating gear - left */}
    <circle cx="28" cy="80" r="16" fill="url(#svc2)" filter="url(#svcShadow)"/>
    <circle cx="28" cy="80" r="8" fill="#064E3B"/>
    <rect x="24" y="61" width="8" height="6" rx="2" fill="#22C55E"/>
    <rect x="24" y="93" width="8" height="6" rx="2" fill="#22C55E"/>
    <rect x="9" y="76" width="6" height="8" rx="2" fill="#22C55E"/>
    <rect x="41" y="76" width="6" height="8" rx="2" fill="#22C55E"/>
...
export const PartnershipIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="15" y="55" width="40" height="28" rx="4" fill="#1D4ED8" filter="url(#ptShadow)"/>
...
export const TradeDelegationsIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="90" y="148" width="20" height="10" rx="2" fill="#22C55E" filter="url(#tdShadow)"/>
    {/* Sparkles */}
...
/* ── "More from UPTECH" section icons ── */
...
export const ProductsIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <filter id="prodSh"><feDropShadow dx="0" dy="4" stdDeviation="5" floodColor="#1E40AF" floodOpacity="0.3"/></filter>
    </defs>
    {/* Phone */}
    ...
    <circle cx="82" cy="68" r="12" fill="#3B82F6" opacity="0.3"/>
    <circle cx="82" cy="68" r="7" fill="#60A5FA" opacity="0.6"/>
    <rect x="66" y="86" width="33" height="3" rx="1" fill="#60A5FA" opacity="0.5"/>
    <rect x="70" y="93" width="25" height="3" rx="1" fill="#60A5FA" opacity="0.35"/>
    <rect x="66" y="102" width="33" height="8" rx="3" fill="#3B82F6" opacity="0.5"/>
    {/* Phone notch */}
    <rect x="73" y="34" width="18" height="4" rx="2" fill="#1E3A5F"/>
    {/* Home indicator */}
    <rect x="74" y="128" width="16" height="3" rx="1.5" fill="#60A5FA" opacity="0.4"/>
    {/* Floating laptop behind */}
    <rect x="100" y="65" width="80" height="55" rx="5" fill="url(#prod2)" filter="url(#prodSh)"/>
    <rect x="105" y="71" width="70" height="40" rx="3" fill="#0F172A"/>
    <path d="M90 120h100l-5 8H95z" fill="#2563EB" opacity="0.6"/>
    {/* Laptop screen content */}
    <rect x="110" y="76" width="28" height="14" rx="2" fill="#3B82F6" opacity="0.3"/>
    <rect x="142" y="76" width="28" height="14" rx="2" fill="#3B82F6" opacity="0.25"/>
    <rect x="110" y="94" width="60" height="3" rx="1" fill="#60A5FA" opacity="0.3"/>
    <rect x="110" y="100" width="45" height="3" rx="1" fill="#60A5FA" opacity="0.2"/>
    {/* Floating gear */}
    <circle cx="30" cy="85" r="14" fill="url(#prod2)" filter="url(#prodSh)"/>
    <circle cx="30" cy="85" r="7" fill="#1E3A5F"/>
    <rect x="26" y="68" width="8" height="5" rx="2" fill="#3B82F6"/>
    <rect x="26" y="97" width="8" height="5" rx="2" fill="#3B82F6"/>
    <rect x="13" y="81" width="5" height="8" rx="2" fill="#3B82F6"/>
    <rect x="42" y="81" width="5" height="8" rx="2" fill="#3B82F6"/>
    {/* Connection lines */}
    <path d="M44 85h11" stroke="#60A5FA" strokeWidth="1.5" strokeDasharray="3 2" opacity="0.4"/>
    {/* Sparkles */}
    <circle cx="160" cy="45" r="3" fill="#93C5FD" opacity="0.6"/>
    <circle cx="25" cy="55" r="2.5" fill="#60A5FA" opacity="0.5"/>
...
export const MentorshipIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="100" cy="52" r="5" fill="#22C55E" opacity="0.8"/>
...
export const MeetingSpaceIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* UK flag on building */}
    <rect x="20" y="30" width="22" height="15" rx="2" fill="#1D4ED8" filter="url(#meetSh)"/>
