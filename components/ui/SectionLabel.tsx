...
export function SectionLabel({ label, title, body, color = "#2563EB", align = "left", light = false, as: Tag = "h2" }: SectionLabelProps) {
  ...
  return (
    <div className={`mb-8 lg:mb-10 ${alignClass}`}>
      ...
      <Tag className={`font-heading font-extrabold text-3xl sm:text-4xl lg:text-[2.8rem] leading-[1.1] ${light ? "text-white" : "text-[#1C1F2E]"}`}>
        {title}
      </Tag>
      {body && (
