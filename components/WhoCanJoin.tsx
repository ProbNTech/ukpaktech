      ...
      <div className="px-8 sm:px-12 lg:px-16 xl:px-20">
        ...
        <div className="relative">
          ...
          <button
            ...
            className={`absolute -left-3 lg:-left-5 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-white border border-gray-200 shadow-lg flex items-center justify-center text-[#2563EB] hover:bg-[#2563EB] hover:text-white hover:border-[#2563EB] transition-all duration-300 ${
          ...
          <button
            ...
            className={`absolute -right-3 lg:-right-5 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-white border border-gray-200 shadow-lg flex items-center justify-center text-[#2563EB] hover:bg-[#2563EB] hover:text-white hover:border-[#2563EB] transition-all duration-300 ${
              ...
              >
                <div className="relative h-full bg-white rounded border border-gray-100 shadow-lg hover:shadow-xl hover:-translate-y-1.5 hover:border-[#2563EB]/20 transition-all duration-300 overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    {/* Blue underline */}
                    <div className="h-[3px] w-12 bg-[#2563EB] rounded-full mt-5 group-hover:w-20 transition-all duration-400" />
                  </div>
                </div>
              </motion.div>
            ))}
