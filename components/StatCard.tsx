  ...
  return (
    ...
    >
      <div className="relative h-full rounded border border-gray-100 bg-white p-8 shadow-md transition-all duration-500 group hover:shadow-lg hover:border-[#2563EB]/20 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-[#2563EB] to-[#22C55E] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
        {icon && (
