    ...
    >
      <div className="px-6 sm:px-10 lg:px-16 xl:px-20">
        <div className="max-w-2xl mb-10">
          <span className="inline-block rounded-full bg-white border border-[#DBEAFE] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-[#1D4ED8]">
            Curation criteria
          </span>
          <h2
            id="curation-heading"
            className="mt-3 font-heading font-extrabold text-[#0F172A] text-2xl sm:text-3xl tracking-tight"
          >
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-[#0F172A] text-base leading-tight">
                      {c.title}
                    </h3>
