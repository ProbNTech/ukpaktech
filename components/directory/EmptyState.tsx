...
export function EmptyState({
  ...
  return (
    <div className="rounded-2xl bg-white border border-dashed border-[#CBD5E1] p-10 text-center">
      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#F1F5F9] text-[#2563EB]">
      ...
      {onReset && (
        <button
          type="button"
          onClick={onReset}
          className="inline-flex items-center gap-2 rounded-full bg-[#2563EB] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#1D4ED8] transition-colors"
        >
          {resetLabel}
        </button>
      )}
