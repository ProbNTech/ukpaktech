      ...
      <div className="relative px-6 sm:px-10 lg:px-16 xl:px-20">
        ...
        <div className="flex items-end justify-between flex-wrap gap-6 mb-10">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-2 rounded-full bg-[#DBEAFE] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-[#1D4ED8]">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="w-10 h-10 inline-flex items-center justify-center rounded-full border border-[#CBD5E1] text-[#0F172A] hover:border-[#0F172A] hover:bg-[#0F172A] hover:text-white transition-colors"
                >
              ...
              {companies.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    i === index ? "bg-[#0F172A] w-8" : "bg-[#CBD5E1] w-2 hover:bg-[#94A3B8]"
                  }`}
                />
              ))}
            </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(140deg, #0B1C2D 0%, ${style.color}40 100%), radial-gradient(circle at 30% 20%, ${style.color}40, transparent 60%)`,
        }}
      >
        <div
          aria-hidden="true"
        ...
        <div className="relative mt-8">
          {company.logoUrl ? (
            ...
            <div className="w-32 h-32 rounded-2xl flex items-center justify-center font-heading font-extrabold text-4xl bg-white text-[#0B1C2D]">
      ...
      <div className="relative lg:col-span-7 p-8 sm:p-10 lg:p-12 flex flex-col">
        <div className="relative max-w-xl">
          <Quote
            ...
            aria-hidden="true"
          />
          <p className="pl-8 text-lg sm:text-xl text-[#0F172A] font-medium leading-relaxed line-clamp-5">
            {company.description}
          </p>
        </div>
        ...
        <div className="mt-9 mt-auto pt-6 flex flex-wrap items-center gap-3">
          {company.websiteUrl && (
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold text-white transition-transform hover:-translate-y-0.5"
              style={{
                background: style.gradient,
                boxShadow: `0 10px 30px -10px ${style.color}80`,
              }}
            >
              Visit website
          ...
          <a
            href="#all-companies"
            className="group inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold text-[#0F172A] border border-[#CBD5E1] hover:border-[#0F172A] transition-colors"
          >
            Explore all members
