    ...
    >
      ...
      <div className="relative px-6 sm:px-10 lg:px-16 xl:px-20">
        <div className="max-w-2xl mb-10">
          <span className="inline-block rounded-full bg-[#DBEAFE] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-[#1D4ED8]">
            By industry
          </span>
          <h2
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="font-heading font-bold text-[#0F172A] text-lg leading-tight">
                    {b.category}
                  </h3>
