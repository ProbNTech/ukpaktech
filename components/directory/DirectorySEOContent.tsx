      ...
      <div className="px-6 sm:px-10 lg:px-16 xl:px-20">
        <div className="max-w-3xl">
          <h2
            ...
            className="font-heading font-extrabold text-[#0F172A] text-2xl sm:text-3xl lg:text-4xl tracking-tight"
          >
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-5">
          <article className="rounded-2xl bg-white border border-[#E5E7EB] p-6 hover:border-[#2563EB]/30 hover:shadow-[0_8px_24px_-12px_rgba(37,99,235,0.18)] transition-all">
            <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-[#DBEAFE] text-[#1D4ED8] mb-4">
              <ListChecks className="w-5 h-5" />
            </div>
            <h3 className="font-heading font-bold text-[#0F172A] text-lg mb-2">
