    ...
    >
      <div className="px-6 sm:px-10 lg:px-16 xl:px-20">
        <div className="max-w-3xl mx-auto text-center">
          <span className="inline-block rounded-full bg-white border border-[#DBEAFE] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-[#2563EB]">
            FAQ
          </span>
          <h2
            id="directory-faq-title"
            className="mt-4 font-heading font-extrabold text-[#0F172A] text-2xl sm:text-3xl lg:text-4xl tracking-tight"
          >
            {title}
          </h2>
          {subtitle && (
            ...
            return (
              <div
                ...
                className={`rounded-2xl border bg-white transition-all duration-200 ${
                  isOpen
                    ? "border-[#2563EB]/40 shadow-[0_10px_30px_-15px_rgba(37,99,235,0.25)]"
                    : "border-[#E5E7EB]"
                }`}
              >
                <button
                ...
                >
                  <span className="font-heading font-semibold text-[#0F172A] text-base sm:text-lg">
                    {faq.question}
                  </span>
                  <ChevronDown
                    className={`w-5 h-5 shrink-0 text-[#2563EB] transition-transform duration-200 ${
                      isOpen ? "rotate-180" : ""
                    }`}
                  />
                </button>
