...
export function DirectoryStats({ companies }: DirectoryStatsProps) {
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(800px circle at 8% 50%, rgba(31,79,216,0.18), transparent 60%), radial-gradient(800px circle at 92% 50%, rgba(1,169,92,0.16), transparent 60%), linear-gradient(180deg, #0B1C2D 0%, #0E2138 100%)",
      }}
    >
      {/* Dotted grid overlay */}
      <div
