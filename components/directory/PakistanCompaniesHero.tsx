...
export function PakistanCompaniesHero({
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 1200px 700px at 50% 0%, rgba(31,79,216,0.28), transparent 70%), radial-gradient(ellipse 1000px 600px at 50% 100%, rgba(1,169,92,0.22), transparent 70%), linear-gradient(180deg, #050B16 0%, #0B1C2D 60%, #0B1C2D 100%)",
      }}
    ...
    >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.05] backdrop-blur-sm px-4 py-2 text-sm text-white">
              ...
              <span className="text-white/65">Curated by UPTECH</span>
            </span>
          </motion.div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, #1F4FD8 0%, #6FE7B4 50%, #C41E3A 100%)",
        }}
      />
