  ...
  return (
    <nav className="flex items-center justify-center gap-2" aria-label="Pagination">
      <button
        ...
        onClick={() => goto(page - 1)}
        disabled={page <= 1}
        className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-[#E2E8F0] bg-white text-[#0F172A] hover:border-[#2563EB] hover:text-[#2563EB] disabled:opacity-40 disabled:hover:border-[#E2E8F0] disabled:hover:text-[#0F172A] transition-colors"
