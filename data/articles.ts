...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "For UPTECH and its members, the London event demonstrates the growing international dimension of Pakistan's AI strategy. The Forum sees the UK–Pakistan AI healthcare roundtable as a template for sector-specific bilateral cooperation that can be replicated across fintech, education, and climate technology. UPTECH will facilitate follow-up engagement between roundtable participants and UK member companies with relevant capabilities.",
    ],
    relatedSlugs: [
  ...
  },
  {
    ...
    title: "Pakistan's National 'Super App' for Government Services Advances Towards Launch",
    category: "Technology",
    ...
    excerpt:
      "Pakistan's ambitious National Super App, consolidating government services, document verification, and digital identity into a single platform, has cleared final development milestones and is advancing towards a nationwide launch.",
    body: [
      "Pakistan's National Super App, an ambitious unified platform designed to consolidate government services, digital document verification, and biometric identity functions into a single citizen-facing application, has advanced through final development and testing milestones, moving towards a phased nationwide launch. The initiative, championed by Federal Minister Shaza Fatima Khawaja, represents Pakistan's most significant single investment in citizen-facing digital government infrastructure.",
