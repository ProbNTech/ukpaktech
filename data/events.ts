export interface Event {
  slug: string;
  title: string;
  category: "London" | "Pakistan" | "Europe" | "UPTECH";
  tag: string;
...
export const events: Event[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    image: "/image/events-and-engagements/nextgen.webp",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/ITCN.webp",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/ASOCIO.webp",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/IDEAS2026.webp",
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    venue: "ExCeL London",
    image: "/image/events-and-engagements/innovation_2026.webp",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/govtech.webp",
  ...
  },
  {
    ...
    dateISO: "2026-05-13",
    location: "London",
    image: "/image/events-and-engagements/Building_smater_state.webp",
  ...
  },
  {
    ...
    location: "Westminster, London",
    venue: "Westminster, London",
    image: "/image/events-and-engagements/gov_transformation_summit_2026.webp",
  ...
  },
  {
    ...
    location: "ExCeL London",
    venue: "ExCeL London",
    image: "/image/events-and-engagements/DigiGovExpo.webp",
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    image: "/image/events-and-engagements/europe/emtech_europe.jpg",
  ...
  },
  {
    ...
    dateISO: "2026-04-21",
    location: "London",
    image: "/image/events-and-engagements/europe/tech_eu_summit.jpg",
  ...
  },
  {
    ...
    venue: "Nova Spektrum",
    image: "/image/events-and-engagements/europe/oslo_tech_show.jpg",
  ...
  },
  {
    ...
    venue: "Kistamässan",
    image: "/image/events-and-engagements/europe/stockholm_tech_show.jpg",
    ...
    body: [
      ...
      "With free exhibition tickets available, the Stockholm Tech Show provides UPTECH members with an accessible entry point to the Nordic enterprise technology market and a platform for building relationships with Scandinavian IT leaders and decision-makers.",
    ],
    relatedSlugs: [
      "oslo-tech-show-2026",
      "techex-europe-2026",
  ...
  },
  {
    ...
    location: "ExCeL London",
    venue: "ExCeL London",
    image: "/image/events-and-engagements/europe/infosecurity_europe.jpg",
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    image: "/image/events-and-engagements/europe/london_tech_week.png",
    ...
    body: [
      ...
      "London Tech Week represents the single most important annual showcase of London's position as a global technology capital. For UPTECH and its members, it provides a premium platform for networking with investors, technology leaders, and potential partners at the heart of Europe's most dynamic tech ecosystem.",
    ],
    relatedSlugs: [
      "ai-summit-london-2026",
  ...
  },
  {
    ...
    venue: "Tobacco Dock",
    image: "/image/events-and-engagements/europe/ai_summit_london.jpg",
    ...
    body: [
      ...
      "For UPTECH members working in AI, data science, and enterprise technology, the AI Summit London provides direct access to the world's leading AI practitioners, decision-makers, and the latest commercial AI solutions, all within the broader context of London Tech Week's unrivalled networking opportunities.",
    ],
    relatedSlugs: [
      "london-tech-week-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/vivatech.png",
    ...
    body: [
      ...
      "VivaTech's scale and international reach make it an essential event for UPTECH members seeking to position UK–Pakistan technology companies within the broader European innovation landscape. The startup and investor density at VivaTech is unmatched by any other European event.",
    ],
    relatedSlugs: [
      "web-summit-2026",
      "tech-eu-summit-london-2026",
  ...
  },
  {
    ...
    dateISO: "2026-06-23",
    location: "London",
    image: "/image/events-and-engagements/europe/ai_world_congress.jpg",
    ...
    body: [
      ...
      "The AI World Congress provides UPTECH members with concentrated access to AI thought leadership, policy discussions, and enterprise AI decision-makers, all within a focused two-day format that maximises networking efficiency for busy technology professionals.",
    ],
    relatedSlugs: [
      "ai-summit-london-2026",
  ...
  },
  {
    ...
    location: "ExCeL London",
    venue: "ExCeL London",
    image: "/image/events-and-engagements/europe/travel_tech_show.webp",
    ...
    body: [
      ...
      "For UPTECH members with technology solutions relevant to the travel, hospitality, and tourism sectors, the Travel Tech Show provides the most efficient and targeted route to European travel industry decision-makers in a focused two-day marketplace format.",
    ],
    relatedSlugs: [
      "london-tech-week-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/point_zero_forum.jpg",
    ...
    body: [
      ...
      "Featured speakers include Martin Schlegel of the Swiss National Bank, Sarah Breeden from the Bank of England, Binance CEO Richard Teng, and Catrin Hinkel of Microsoft Switzerland. For UPTECH members in fintech, digital payments, and financial technology, the Point Zero Forum provides direct engagement with the regulators and policymakers shaping Europe's financial technology landscape.",
    ],
    relatedSlugs: [
      "vivatech-2026",
      "gitex-ai-europe-2026",
  ...
  },
  {
    ...
    venue: "Messe Berlin",
    image: "/image/events-and-engagements/europe/gitex_ai_europe.webp",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/ai_for_good.png",
    ...
    body: [
      ...
      "For UPTECH and its members, the AI for Good Summit provides a unique platform at the intersection of AI technology, international policy, and sustainable development, areas where UK–Pakistan technology partnerships can contribute meaningfully to global technology governance and responsible AI deployment.",
    ],
    relatedSlugs: [
      "ai-summit-london-2026",
      "world-summit-ai-2026",
  ...
  },
  {
    ...
    venue: "Amsterdam RAI",
    image: "/image/events-and-engagements/europe/ibc2026.png",
    ...
    body: [
      ...
      "IBC's unique position at the intersection of media, technology, and content creation makes it relevant for UPTECH members working in digital content, broadcasting technology, media platforms, and entertainment technology, sectors where UK–Pakistan collaboration has significant growth potential.",
    ],
    relatedSlugs: [
      "london-tech-week-2026",
      "techex-europe-2026",
  ...
  },
  {
    ...
    location: "ExCeL London",
    venue: "ExCeL London",
    image: "/image/events-and-engagements/europe/tech_for_marketing.png",
    ...
    body: [
      ...
      "For UPTECH members developing marketing technology, AI-powered analytics, or digital customer experience platforms, Technology for Marketing provides targeted access to the UK's largest concentration of marketing technology buyers and decision-makers in a single event.",
    ],
    relatedSlugs: [
      "big-data-ldn-2026",
      "ai-summit-london-2026",
  ...
  },
  {
    ...
    location: "Olympia London",
    venue: "Olympia London",
    image: "/image/events-and-engagements/europe/big_data_ldn.png",
    ...
    body: [
      ...
      "Big Data LDN's focused positioning at the intersection of data engineering, analytics, and AI makes it the most relevant annual event for UPTECH members developing data platforms, analytics solutions, or AI products for enterprise markets.",
    ],
    relatedSlugs: [
      "ai-summit-london-2026",
      "tech-for-marketing-2026",
  ...
  },
  {
    ...
    location: "Olympia, London",
    venue: "Olympia London",
    image: "/image/events-and-engagements/europe/international_security_expo.jpg",
    ...
    body: [
      ...
      "Chaired by Figen Murray OBE, the initiator of Martyn's Law, the expo features immersive demonstrations, expert summits, and targeted networking. For UPTECH members in security technology, the International Security Expo provides direct engagement with the UK's most senior security decision-makers across government and enterprise.",
    ],
    relatedSlugs: [
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/isaca_europe.jpg",
  ...
  },
  {
    ...
    body: [
      ...
      "For UPTECH members working in AI, machine learning, and data science, World Summit AI provides access to the global AI leadership community and the latest thinking on how artificial intelligence is reshaping industries, governments, and societies, essential context for UK–Pakistan technology partnerships operating in the AI space.",
    ],
    relatedSlugs: [
      "ai-summit-london-2026",
      "ai-for-good-summit-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/cybertech_europe.jpg",
  ...
  },
  {
    ...
    location: "Amsterdam, Netherlands",
    venue: "RAI Amsterdam",
    image: "/image/events-and-engagements/europe/techex_europe.png",
    ...
    body: [
      ...
      "TechEx Europe's unique format of six co-located conferences under one ticket makes it exceptionally efficient for UPTECH members seeking cross-domain technology insights and networking across AI, cybersecurity, cloud, IoT, and digital transformation, all within a focused two-day programme.",
    ],
    relatedSlugs: [
      "gitex-ai-europe-2026",
      "oslo-tech-show-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/itsa_expo.jpg",
    ...
    body: [
      ...
      "For UPTECH members developing cybersecurity products and services targeting the European market, it-sa provides the most concentrated access to German and continental European IT security decision-makers, Germany being Europe's largest technology market and a critical gateway for UK–Pakistan technology exports.",
    ],
    relatedSlugs: [
      "infosecurity-europe-2026",
      "cybertech-europe-2026",
  ...
  },
  {
    ...
    venue: "QEII Centre",
    image: "/image/events-and-engagements/europe/cyber_security_expo.png",
    ...
    body: [
      ...
      "For UPTECH members building cybersecurity teams or seeking to connect UK–Pakistani cybersecurity talent with leading employers, the Cyber Security EXPO provides a uniquely focused talent marketplace that complements the broader cybersecurity conference landscape.",
    ],
    relatedSlugs: [
      "infosecurity-europe-2026",
      "international-security-expo-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/data_ai_conference.jpg",
    ...
    body: [
      ...
      "With networking opportunities connecting 250+ data professionals and an industry awards programme recognising excellence in data strategy transformation, the conference provides UPTECH members with practical intelligence on enterprise data and AI best practices from Europe's leading practitioners.",
    ],
    relatedSlugs: [
      "big-data-ldn-2026",
      "ai-world-congress-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/web_summit.jpg",
  ...
  },
  {
    ...
    dateISO: "2026-11-16",
    location: "Zurich, Switzerland",
    image: "/image/events-and-engagements/europe/swiss_ai_summit.jpg",
    ...
    body: [
      ...
      "Switzerland's position as a global hub for AI research, particularly through ETH Zurich and EPFL, makes the Swiss AI Summit a valuable event for UPTECH members seeking to connect with one of Europe's most sophisticated AI ecosystems and explore collaboration opportunities with Swiss AI companies and research institutions.",
    ],
    relatedSlugs: [
      "world-summit-ai-2026",
      "ai-for-good-summit-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/space_tech_expo.jpg",
    ...
    body: [
      ...
      "For UPTECH members in satellite communications, earth observation, space software, or defence technology, Space Tech Expo Europe provides the most efficient access to the European space industry supply chain, a rapidly growing sector where UK–Pakistan technology partnerships have emerging opportunities in satellite data, communications infrastructure, and ground segment solutions.",
    ],
    relatedSlugs: [
      "gitex-ai-europe-2026",
      "techex-europe-2026",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/gitex_global_2026.jpg",
    ...
    body: [
      ...
      "GITEX Global's scale and its position as the premier technology event in the Middle East make it strategically important for UPTECH, providing a bridge between European and Asian technology markets. Dubai's role as a global technology crossroads creates unique opportunities for UK–Pakistan technology companies to engage with investors, governments, and enterprises across the Gulf, Africa, and South Asia.",
    ],
    relatedSlugs: [
      "gitex-ai-europe-2026",
      "vivatech-2026",
  ...
  },
  {
    ...
    location: "Olympia London",
    venue: "Olympia London",
    image: "/image/events-and-engagements/europe/ai_big_data_expo_2027.jpg",
    ...
    body: [
      ...
      "The expo's dedicated startup innovation area and focus on practical AI implementation make it particularly valuable for UPTECH members seeking to showcase AI products, find enterprise customers, and connect with the London AI ecosystem, the largest in Europe, at the start of a new business year.",
    ],
    relatedSlugs: [
      "ai-summit-london-2026",
      "big-data-ldn-2026",
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    image: "/image/events-and-engagements/europe/ai4.jpg",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/conf3rence.jpg",
  ...
  },
  {
    ...
    venue: "PTAK Warsaw Expo, Nadarzyn (Warsaw), Poland",
    image: "/image/events-and-engagements/europe/warsaw_tech_week.jpg",
  ...
  },
  {
    ...
    location: "ExCeL London",
    venue: "ExCeL London",
    image: "/image/events-and-engagements/europe/ecommerce_expo.png",
  ...
  },
  {
    ...
    location: "Olympia London",
    venue: "Olympia London",
    image: "/image/events-and-engagements/europe/international_cyber_expo.png",
  ...
  },
  {
    ...
    image: "/image/events-and-engagements/europe/tech_week_singapore.jpg",
  ...
  /* ------------------------------------------------------------------ */
  {
    slug: "uk-pakistan-tech-forum-london-2026",
    title: "UK–Pakistan Tech Forum, London",
    category: "UPTECH",
    tag: "Networking",
    status: "past",
    date: "June 11, 2026",
    ...
    venue: "West London, United Kingdom",
    image: "/image/events-and-engagements/london_tech_week_dinner/1.jpeg",
    gallery: [
      "/image/events-and-engagements/london_tech_week_dinner/1.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/2.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/3.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/4.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/5.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/6.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/7.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/8.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/9.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/10.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/11.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/12.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/13.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/14.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/15.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/16.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/17.jpeg",
      "/image/events-and-engagements/london_tech_week_dinner/18.jpeg",
    ],
    officialLink: "https://www.ukpaktech.org.uk/",
    excerpt:
      "UPTECH welcomed Pakistani delegates from PSEB, P@SHA and the Pakistan Tech Forum (PTF) to a UK–Pakistan Tech Forum in West London during London Tech Week 2026, connecting visiting delegates with the UK technology ecosystem.",
    body: [
      "On 11 June 2026, UPTECH was delighted to welcome Pakistani delegates from the Pakistan Software Export Board (PSEB), the Pakistan Software Houses Association (P@SHA), and the Pakistan Tech Forum (PTF) to a UK–Pakistan Tech Forum in West London, bringing together delegates visiting for London Tech Week and key stakeholders from across the UK technology ecosystem.",
      "The forum provided a valuable platform to strengthen connections, exchange ideas, and explore opportunities for collaboration across innovation, entrepreneurship, investment, AI, digital transformation, and emerging technologies.",
      "As Pakistan's tech sector continues to grow and gain global recognition, deeper engagement between the UK and Pakistan can unlock new avenues for trade, talent development, investment, and technology partnerships.",
      "Our thanks to all the delegates, speakers, partners, and participants who contributed to meaningful discussions and helped make the event a success. We look forward to building on this momentum and fostering stronger UK–Pakistan tech ties in the years ahead.",
    ],
    relatedSlugs: [
  ...
  {
    slug: "london-tech-week-2026-highlights",
    title: "London Tech Week 2026, UK–Pakistan Highlights",
    category: "UPTECH",
    tag: "Conference",
    status: "past",
    date: "June 8–12, 2026",
    ...
    location: "Olympia London",
    venue: "Olympia London",
    image: "/image/events-and-engagements/london_tech_week/1.jpeg",
    gallery: [
      "/image/events-and-engagements/london_tech_week/1.jpeg",
      "/image/events-and-engagements/london_tech_week/2.jpeg",
      "/image/events-and-engagements/london_tech_week/3.jpeg",
      "/image/events-and-engagements/london_tech_week/4.jpeg",
      "/image/events-and-engagements/london_tech_week/5.jpeg",
      "/image/events-and-engagements/london_tech_week/6.jpeg",
      "/image/events-and-engagements/london_tech_week/7.jpeg",
      "/image/events-and-engagements/london_tech_week/8.jpeg",
      "/image/events-and-engagements/london_tech_week/9.jpeg",
      "/image/events-and-engagements/london_tech_week/10.jpeg",
      "/image/events-and-engagements/london_tech_week/11.jpeg",
      "/image/events-and-engagements/london_tech_week/12.jpeg",
      "/image/events-and-engagements/london_tech_week/13.jpeg",
      "/image/events-and-engagements/london_tech_week/14.jpeg",
      "/image/events-and-engagements/london_tech_week/15.jpeg",
      "/image/events-and-engagements/london_tech_week/16.jpeg",
      "/image/events-and-engagements/london_tech_week/17.jpeg",
      "/image/events-and-engagements/london_tech_week/18.jpeg",
      "/image/events-and-engagements/london_tech_week/19.jpeg",
      "/image/events-and-engagements/london_tech_week/20.jpeg",
      "/image/events-and-engagements/london_tech_week/21.jpeg",
    ],
    officialLink: "https://londontechweek.com/",
    excerpt:
    ...
    relatedSlugs: [
      "uk-pakistan-tech-forum-london-2026",
      "london-tech-week-2026",
      "ai-summit-london-2026",
    ],
  },
